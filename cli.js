...
import {
  initCpuProfiler
} from "./chunks/chunk-566AVFQN.js";
import "./chunks/chunk-VA5USJVE.js";
import {
  initStartupProfiler
...
async function runCliEntry(rawArgv = process.argv.slice(2)) {
  ...
  if (managedUpdateVersion) {
    ...
    const { installManagedNpmUpdate } = await import("./chunks/managed-npm-update-IZLR7UYR.js");
  ...
  if (route === "serve") {
    const { tryRunServeFastPath } = await import("./chunks/fast-path-B5PXHPFM.js");
  ...
  const { main } = await import("./chunks/gemini-CA2NLIG3.js");
...
async function handleCriticalError(error) {
  const [{ FatalError }, { AlreadyReportedError }] = await Promise.all([
    import("./chunks/deferred-core-runtime-LFQWR3DZ.js"),
    import("./chunks/errors-BL6J2FIO.js")
  ]);
