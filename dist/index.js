...
import { createContext, useContext, useState, useRef, useMemo, useEffect, Fragment as Fragment$1, useCallback, memo, forwardRef, useImperativeHandle } from "react";
import { i as isAgentTool } from "./toolNames-kewwpc1v.js";
...
const PlatformContext = createContext(defaultContext);
 ...
 */
const ExpandControlContext = createContext(null);
 ...
 * SPDX-License-Identifier: Apache-2.0
 */
const Container = ({ children, className = "" }) => /* @__PURE__ */ jsx("div", { className: `container mx-auto px-4 ${className}`, children });
/**
 * @license
 * Copyright 2025 Qwen Team
 * SPDX-License-Identifier: Apache-2.0
 */
const Header = () => /* @__PURE__ */ jsx("header", { children: "Header Component Placeholder" });
/**
 * @license
 * Copyright 2025 Qwen Team
 * SPDX-License-Identifier: Apache-2.0
 */
const Sidebar = () => /* @__PURE__ */ jsx("aside", { children: "Sidebar Component Placeholder" });
/**
 * @license
 * Copyright 2025 Qwen Team
 * SPDX-License-Identifier: Apache-2.0
 */
const Main = () => /* @__PURE__ */ jsx("main", { children: "Main Component Placeholder" });
/**
 * @license
 * Copyright 2025 Qwen Team
 * SPDX-License-Identifier: Apache-2.0
 */
const Footer = () => /* @__PURE__ */ jsx("footer", { children: "Footer Component Placeholder" });
...
const FileLink = ({
  ...
  return /* @__PURE__ */ jsxs(
    "button",
    {
      ...
      disabled: isDisabled,
      children: [
        /* @__PURE__ */ jsx("span", { className: "file-link-path", children: displayPath }),
        line !== null && line !== void 0 && /* @__PURE__ */ jsxs("span", { className: "file-link-location opacity-70 text-[0.9em] font-normal dark:opacity-60", children: [
          ":",
          line,
          column !== null && column !== void 0 && /* @__PURE__ */ jsxs(Fragment, { children: [
            ":",
            column
          ] })
        ] })
...
const PlusIcon = ({ size = 20, className, ...props }) => /* @__PURE__ */ jsx(
  "svg",
  {
    xmlns: "http://www.w3.org/2000/svg",
    viewBox: "0 0 20 20",
    ...
    "aria-hidden": "true",
    ...props,
    children: /* @__PURE__ */ jsx("path", { d: "M10.75 4.75a.75.75 0 0 0-1.5 0v4.5h-4.5a.75.75 0 0 0 0 1.5h4.5v4.5a.75.75 0 0 0 1.5 0v-4.5h4.5a.75.75 0 0 0 0-1.5h-4.5v-4.5Z" })
  }
);
const PlusSmallIcon = ({
  size = 16,
  ...
  "svg",
  {
    ...
    "aria-hidden": "true",
    ...props,
    children: /* @__PURE__ */ jsx("path", { d: "M8 2a.5.5 0 0 1 .5.5V5h2.5a.5.5 0 0 1 0 1H8.5v2.5a.5.5 0 0 1-1 0V6H5a.5.5 0 0 1 0-1h2.5V2.5A.5.5 0 0 1 8 2Z" })
  }
);
const ArrowUpIcon = ({
  size = 20,
...
const CloseSmallIcon = ({
  ...
  "svg",
  {
    ...
    "aria-hidden": "true",
    ...props,
    children: /* @__PURE__ */ jsx("path", { d: "M4.646 4.646a.5.5 0 0 1 .708 0L8 7.293l2.646-2.647a.5.5 0 0 1 .708.708L8.707 8l2.647 2.646a.5.5 0 0 1-.708.708L8 8.707l-2.646 2.647a.5.5 0 0 1-.708-.708L7.293 8 4.646 5.354a.5.5 0 0 1 0-.708Z" })
  }
);
const SearchIcon = ({
  size = 20,
...
const RefreshIcon = ({
  ...
  "svg",
  {
    ...
    ...props,
    children: [
      /* @__PURE__ */ jsx("path", { d: "M13.3333 8C13.3333 10.9455 10.9455 13.3333 8 13.3333C5.05451 13.3333 2.66663 10.9455 2.66663 8C2.66663 5.05451 5.05451 2.66663 8 2.66663" }),
      /* @__PURE__ */ jsx("path", { d: "M10.6666 8L13.3333 8M13.3333 8L13.3333 5.33333M13.3333 8L10.6666 10.6667" })
    ]
  }
);
const ChatHeader = ({
    ...
    children: [
      /* @__PURE__ */ jsxs(
        "button",
        {
          ...
          children: [
            /* @__PURE__ */ jsx("span", { className: "whitespace-nowrap overflow-hidden text-ellipsis min-w-0 font-medium text-[var(--app-primary-foreground)]", children: currentSessionTitle }),
            /* @__PURE__ */ jsx(ChevronDownIcon, { className: "w-4 h-4 flex-shrink-0 text-[var(--app-primary-foreground)]" })
          ]
        }
      ),
      ...
      /* @__PURE__ */ jsx(
        "button",
        {
          ...
          style: { padding: "4px" },
          children: /* @__PURE__ */ jsx(PlusIcon, { className: "w-4 h-4 text-[var(--app-primary-foreground)]" })
        }
      )
    ]
  }
...
const Tooltip = ({
  ...
  content,
  position = "top"
}) => /* @__PURE__ */ jsx("div", { className: "relative inline-block", children: /* @__PURE__ */ jsxs("div", { className: "group relative", children: [
  children,
  /* @__PURE__ */ jsxs(
    "div",
    {
...
const ContextIndicator = ({
  ...
  const tooltipContent = /* @__PURE__ */ jsx("div", { className: "flex flex-col gap-1", children: /* @__PURE__ */ jsxs("div", { className: "font-medium", children: [
    percentFormatted,
    "% • ",
  ...
  return /* @__PURE__ */ jsx(Tooltip, { content: tooltipContent, position: "top", children: /* @__PURE__ */ jsx("button", { type: "button", className: "btn-icon-compact", "aria-label": ariaLabel, children: /* @__PURE__ */ jsxs("svg", { viewBox: "0 0 24 24", "aria-hidden": "true", role: "presentation", children: [
    /* @__PURE__ */ jsx(
      "circle",
      {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxs(
          "div",
          {
            ...
            children: [
              title && !hasGroups && /* @__PURE__ */ jsx("div", { className: "completion-menu-section-label px-3 py-1 text-[var(--app-primary-foreground)] opacity-50 text-[0.9em]", children: title }),
              groupedItems.map((group, groupIdx) => /* @__PURE__ */ jsxs(
                "div",
                {
                  className: "completion-menu-group",
                  children: [
                    hasGroups && group.group && /* @__PURE__ */ jsx("div", { className: "completion-menu-section-label px-3 py-1.5 text-[var(--app-secondary-foreground)] text-[0.8em] uppercase tracking-wider", children: group.group }),
                    /* @__PURE__ */ jsx("div", { className: "flex flex-col gap-[var(--app-list-gap)]", children: group.items.map((item) => {
                      ...
                      return /* @__PURE__ */ jsx(
                        "div",
                        {
                          ...
                          children: /* @__PURE__ */ jsxs("div", { className: "completion-menu-item-row flex items-center justify-between gap-2", children: [
                            item.icon && /* @__PURE__ */ jsx("span", { className: "completion-menu-item-icon inline-flex h-4 w-4 items-center justify-center text-[var(--vscode-symbolIcon-fileForeground,#cccccc)]", children: item.icon }),
                            /* @__PURE__ */ jsx(
                              "span",
                              {
                                className: [
  ...
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    ...
    /* @__PURE__ */ jsxs(
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ jsxs("div", { className: "session-search p-2 flex items-center gap-2", children: [
            /* @__PURE__ */ jsx(SearchIcon, { className: "session-search-icon w-4 h-4 opacity-50 flex-shrink-0 text-[var(--app-primary-foreground)]" }),
            /* @__PURE__ */ jsx(
              "input",
              {
                type: "text",
          ...
          /* @__PURE__ */ jsxs(
            "div",
            {
              ...
              children: [
                ...
                ) : groupSessionsByDate(sessions).map((group) => /* @__PURE__ */ jsxs(Fragment$1, { children: [
                  /* @__PURE__ */ jsx("div", { className: "session-group-label p-1 px-2 text-[var(--app-primary-foreground)] opacity-50 text-[0.9em] font-medium [&:not(:first-child)]:mt-2", children: group.label }),
                  /* @__PURE__ */ jsx("div", { className: "session-group flex flex-col gap-[2px]", children: group.sessions.map((session) => {
                    ...
                    return /* @__PURE__ */ jsxs(
                      "div",
                      {
                        ...
                        children: [
                          /* @__PURE__ */ jsx("span", { className: "session-item-title flex-1 overflow-hidden text-ellipsis whitespace-nowrap min-w-0 text-[var(--vscode-chat-font-size,13px)] font-[var(--vscode-chat-font-family)]", children: title }),
                          /* @__PURE__ */ jsxs("span", { className: "flex items-center gap-1 flex-shrink-0 ml-2", children: [
                            (onRenameSession || onDeleteSession) && /* @__PURE__ */ jsxs(
                              "span",
                              {
                                className: `items-center gap-0.5 ${confirmDeleteId === sessionId ? "flex" : "hidden group-hover:flex"}`,
                                children: [
                                  onRenameSession && /* @__PURE__ */ jsx(
                                    "button",
                                    {
                                      type: "button",
                                      ...
                                      children: /* @__PURE__ */ jsx(
                                        "svg",
                                        {
                                          ...
                                          viewBox: "0 0 16 16",
                                          fill: "currentColor",
                                          children: /* @__PURE__ */ jsx("path", { d: "M13.23 1h-1.46L3.52 9.25l-.16.22L1 13.59 2.41 15l4.12-2.36.22-.16L15 4.23V2.77L13.23 1zM2.41 13.59l1.51-3 1.45 1.45-2.96 1.55zm3.83-2.06L4.47 9.76l8-8 1.77 1.77-8 8z" })
                                        }
                                      )
                                    }
                                  ),
                                  onDeleteSession && !isActive && (confirmDeleteId === sessionId ? /* @__PURE__ */ jsx(
                                    "button",
                                    {
                                      type: "button",
                                    ...
                                    "button",
                                    {
                                      ...
                                      children: /* @__PURE__ */ jsx(
                                        "svg",
                                        {
                                          ...
                                          viewBox: "0 0 16 16",
                                          fill: "currentColor",
                                          children: /* @__PURE__ */ jsx("path", { d: "M10 3h3v1h-1v9l-1 1H5l-1-1V4H3V3h3V2a1 1 0 0 1 1-1h2a1 1 0 0 1 1 1v1zM9 2H7v1h2V2zM5 4v9h6V4H5zm2 2h1v5H7V6zm3 0h-1v5h1V6z" })
                                        }
                                      )
                                    }
                                  ))
                            ...
                            /* @__PURE__ */ jsx("span", { className: "session-item-time opacity-60 text-[0.9em]", children: getTimeAgo(lastUpdated) })
                          ] })
                        ]
                      },
                      sessionId
                ...
                hasMore && /* @__PURE__ */ jsx("div", { className: "p-2 text-center opacity-60 text-[0.9em]", children: isLoading ? "Loading…" : "" })
              ]
            }
          )
        ]
...
const EmptyState = ({
  ...
  return /* @__PURE__ */ jsx("div", { className: "flex flex-col items-center justify-center h-full p-5 md:p-10", children: /* @__PURE__ */ jsx("div", { className: "flex flex-col items-center gap-8 w-full", children: /* @__PURE__ */ jsxs("div", { className: "flex flex-col items-center gap-6", children: [
    iconUri ? /* @__PURE__ */ jsx(
      "img",
      {
        src: iconUri,
        alt: `${appName} Logo`,
    ...
    ) : /* @__PURE__ */ jsx("div", { className: "w-[60px] h-[60px] flex items-center justify-center text-2xl font-bold bg-gray-200 rounded", children: appName.charAt(0).toUpperCase() }),
    /* @__PURE__ */ jsx("div", { className: "text-center", children: /* @__PURE__ */ jsx("div", { className: "text-[15px] text-app-primary-foreground leading-normal font-normal max-w-[400px]", children: description }) })
  ] }) }) });
};
/**
 * @license
...
const AutoEditIcon = ({
  ...
  "svg",
  {
    ...
    "aria-hidden": "true",
    ...props,
    children: /* @__PURE__ */ jsx("path", { d: "M2.53 3.956A1 1 0 0 0 1 4.804v6.392a1 1 0 0 0 1.53.848l5.113-3.196c.16-.1.279-.233.357-.383v2.73a1 1 0 0 0 1.53.849l5.113-3.196a1 1 0 0 0 0-1.696L9.53 3.956A1 1 0 0 0 8 4.804v2.731a.992.992 0 0 0-.357-.383L2.53 3.956Z" })
  }
);
const PlanModeIcon = ({
  size = 16,
  ...
  "svg",
  {
    ...
    "aria-hidden": "true",
    ...props,
    children: /* @__PURE__ */ jsx("path", { d: "M4.5 2a.5.5 0 0 0-.5.5v11a.5.5 0 0 0 .5.5h1a.5.5 0 0 0 .5-.5v-11a.5.5 0 0 0-.5-.5h-1ZM10.5 2a.5.5 0 0 0-.5.5v11a.5.5 0 0 0 .5.5h1a.5.5 0 0 0 .5-.5v-11a.5.5 0 0 0-.5-.5h-1Z" })
  }
);
...
const HideContextIcon = ({
  ...
  "svg",
  {
    ...
    children: [
      ...
      /* @__PURE__ */ jsx("path", { d: "m10.748 13.93 2.523 2.523a9.987 9.987 0 0 1-3.27.547c-4.258 0-7.894-2.66-9.337-6.41a1.651 1.651 0 0 1 0-1.186A10.007 10.007 0 0 1 2.839 6.02L6.07 9.252a4 4 0 0 0 4.678 4.678Z" })
    ]
  }
);
...
const LinkIcon = ({ size = 20, className, ...props }) => /* @__PURE__ */ jsx(
  "svg",
  {
    xmlns: "http://www.w3.org/2000/svg",
    viewBox: "0 0 20 20",
...
const OpenDiffIcon = ({
  ...
  "svg",
  {
    ...
    "aria-hidden": "true",
    ...props,
    children: /* @__PURE__ */ jsx("path", { d: "M13.5 7l-4-4v3h-6v2h6v3l4-4z" })
  }
);
const UndoIcon = ({ size = 16, className, ...props }) => /* @__PURE__ */ jsx(
  "svg",
  {
    xmlns: "http://www.w3.org/2000/svg",
    viewBox: "0 0 16 16",
...
const CopyIcon = ({ size = 16, className, ...props }) => /* @__PURE__ */ jsxs(
  "svg",
  {
    xmlns: "http://www.w3.org/2000/svg",
    viewBox: "0 0 16 16",
 ...
 */
const StopIcon = ({ size = 16, className, ...props }) => /* @__PURE__ */ jsx(
  "svg",
  {
    xmlns: "http://www.w3.org/2000/svg",
    viewBox: "0 0 16 16",
    ...
    "aria-hidden": "true",
    ...props,
    children: /* @__PURE__ */ jsx("rect", { x: "4", y: "4", width: "8", height: "8", rx: "1" })
  }
);
/**
 * @license
...
const getEditModeIcon = (iconType) => {
  switch (iconType) {
    case "edit":
      return /* @__PURE__ */ jsx(EditPencilIcon, {});
    case "auto":
    case "yolo":
      return /* @__PURE__ */ jsx(AutoEditIcon, {});
    case "plan":
      return /* @__PURE__ */ jsx(PlanModeIcon, {});
    default:
      return null;
  }
};
const InputForm = ({
  ...
  return /* @__PURE__ */ jsx("div", { className: "p-1 px-4 pb-4 absolute bottom-0 left-0 right-0 bg-gradient-to-b from-transparent to-[var(--app-primary-background)] pointer-events-none", children: /* @__PURE__ */ jsx("div", { className: "block pointer-events-auto", children: /* @__PURE__ */ jsxs("form", { className: "composer-form", onSubmit, children: [
    /* @__PURE__ */ jsx("div", { className: "composer-overlay" }),
    /* @__PURE__ */ jsx("div", { className: "input-banner" }),
    /* @__PURE__ */ jsxs("div", { className: "relative flex z-[1]", children: [
      completionActive && onCompletionSelect && onCompletionClose && /* @__PURE__ */ jsx(
        CompletionMenu,
        {
    ...
    extraContent ? /* @__PURE__ */ jsx("div", { className: "relative z-[1]", children: extraContent }) : null,
    /* @__PURE__ */ jsxs("div", { className: "composer-actions", children: [
      /* @__PURE__ */ jsxs(
        "button",
        {
          type: "button",
          ...
          children: [
            editModeInfo.icon,
            /* @__PURE__ */ jsx("span", { className: "hidden sm:inline", children: editModeInfo.label })
          ]
        }
      ),
      activeFileName && /* @__PURE__ */ jsxs(
        "button",
        {
          type: "button",
          className: "btn-text-compact btn-text-compact--primary",
          ...
          children: [
            skipAutoActiveContext ? /* @__PURE__ */ jsx(HideContextIcon, {}) : /* @__PURE__ */ jsx(CodeBracketsIcon, {}),
            /* @__PURE__ */ jsx("span", { className: "hidden sm:inline", children: selectedLinesText || activeFileName })
          ]
        }
      ),
      /* @__PURE__ */ jsx("div", { className: "flex-1 min-w-0" }),
      /* @__PURE__ */ jsx(ContextIndicator, { contextUsage }),
      /* @__PURE__ */ jsx(
        "button",
        {
          type: "button",
          ...
          children: /* @__PURE__ */ jsx(SlashCommandIcon, {})
        }
      ),
      /* @__PURE__ */ jsx(
        "button",
      ...
      isStreaming || isWaitingForResponse ? /* @__PURE__ */ jsx(
        "button",
        {
          type: "button",
...
const Onboarding = ({
...
}) => /* @__PURE__ */ jsx("div", { className: "flex flex-col items-center justify-center h-full p-5 md:p-10", children: /* @__PURE__ */ jsx("div", { className: "flex flex-col items-center gap-8 w-full max-w-md mx-auto", children: /* @__PURE__ */ jsxs("div", { className: "flex flex-col items-center gap-6", children: [
  iconUrl && /* @__PURE__ */ jsx("div", { className: "relative", children: /* @__PURE__ */ jsx(
    "img",
    {
      src: iconUrl,
      alt: `${appName} Logo`,
  ...
  /* @__PURE__ */ jsxs("div", { className: "text-center", children: [
    /* @__PURE__ */ jsxs("h1", { className: "text-2xl font-bold text-[var(--app-primary-foreground)] mb-2", children: [
      "Welcome to ",
      appName
    ] }),
    /* @__PURE__ */ jsx("p", { className: "text-[var(--app-secondary-foreground)] max-w-sm", children: subtitle })
  ] }),
  /* @__PURE__ */ jsx(
    "button",
    {
...
const Message = ({
  ...
  return /* @__PURE__ */ jsx("div", { className: `flex ${alignment} mb-4 ${className}`, children: /* @__PURE__ */ jsxs(
    "div",
    {
      className: `${bgColor} text-white rounded-lg px-4 py-2 max-w-xs md:max-w-md lg:max-w-lg`,
      children: [
        content,
        timestamp && /* @__PURE__ */ jsx("div", { className: "text-xs opacity-70 mt-1", children: timestamp.toLocaleTimeString([], {
          hour: "2-digit",
          minute: "2-digit"
        }) })
      ]
 ...
 * SPDX-License-Identifier: Apache-2.0
 */
const MessageInput = () => /* @__PURE__ */ jsx("div", { children: "MessageInput Component Placeholder" });
/**
 * @license
 * Copyright 2025 Qwen Team
 * SPDX-License-Identifier: Apache-2.0
 */
const MessageList = () => /* @__PURE__ */ jsx("div", { children: "MessageList Component Placeholder" });
...
const WaitingMessage = ({ loadingMessage }) => {
  ...
  return /* @__PURE__ */ jsx("div", { className: "waiting-message-outer flex gap-0 items-start text-left py-2 flex-col opacity-85", children: /* @__PURE__ */ jsx("div", { className: "assistant-message-container assistant-message-loading waiting-message-inner w-full items-start pl-[30px] relative", children: /* @__PURE__ */ jsx("span", { className: "waiting-message-text opacity-70 italic loading-text-shimmer", children: phrases[index] }) }) });
};
/**
 * @license
 * Copyright 2025 Qwen Team
...
}) => /* @__PURE__ */ jsx("div", { className: "flex gap-0 items-start text-left py-2 flex-col opacity-85", children: /* @__PURE__ */ jsx("div", { className: "interrupted-item w-full relative", children: /* @__PURE__ */ jsx("span", { className: "opacity-70 italic", children: text2 }) }) });
const decodeCache = {};
...
const MessageContent = memo(MessageContentBase);
        ...
        /* @__PURE__ */ jsxs(
          "button",
          {
            ...
            children: [
              ...
              /* @__PURE__ */ jsx("span", { className: "text-sm flex-shrink-0", children: "📄" }),
              /* @__PURE__ */ jsx(
                "span",
                {
...
const CollapsibleFileContent = ({
  ...
  return /* @__PURE__ */ jsx("div", { className: "flex flex-col gap-2", children: segments.map((segment, index) => {
...
const PlanCompletedIcon = ({
  ...
  "svg",
  {
    ...
    ...props,
    children: [
      /* @__PURE__ */ jsx("circle", { cx: "7", cy: "7", r: "6", fill: "currentColor", opacity: "0.2" }),
      /* @__PURE__ */ jsx(
        "path",
        {
...
const UserIcon = ({ size = 16, className, ...props }) => /* @__PURE__ */ jsx(
  "svg",
  {
    xmlns: "http://www.w3.org/2000/svg",
    viewBox: "0 0 16 16",
...
const SymbolIcon = ({
  ...
  "svg",
  {
    ...
    "aria-hidden": "true",
    ...props,
    children: /* @__PURE__ */ jsx("path", { d: "M8 1a.5.5 0 0 1 .5.5v5.793l2.146-2.147a.5.5 0 0 1 .708.708l-3 3a.5.5 0 0 1-.708 0l-3-3a.5.5 0 1 1 .708-.708L7.5 7.293V1.5A.5.5 0 0 1 8 1Z" })
  }
);
const SelectionIcon = ({
  size = 16,
  ...
  "svg",
  {
    ...
    "aria-hidden": "true",
    ...props,
    children: /* @__PURE__ */ jsx("path", { d: "M2 3.5a.5.5 0 0 1 .5-.5h11a.5.5 0 0 1 0 1h-11a.5.5 0 0 1-.5-.5Zm0 4a.5.5 0 0 1 .5-.5h7a.5.5 0 0 1 0 1h-7a.5.5 0 0 1-.5-.5Zm0 4a.5.5 0 0 1 .5-.5h9a.5.5 0 0 1 0 1h-9a.5.5 0 0 1-.5-.5Z" })
  }
);
const CheckIcon = ({
  size = 16,
...
const MessageMeta = ({
  ...
  return /* @__PURE__ */ jsxs("div", { className: "mt-1 flex min-h-6 items-center gap-1 text-xs text-[var(--app-secondary-foreground)]", children: [
    formattedTime && /* @__PURE__ */ jsx("time", { className: "select-none opacity-60", dateTime, children: formattedTime }),
    /* @__PURE__ */ jsxs(
      "div",
      {
      ...
      children: [
        ...
        /* @__PURE__ */ jsx(
          MessageMeta,
          {
            ...
            onEdit,
            editDisabled,
            editIcon: /* @__PURE__ */ jsx(EditPencilIcon, { size: 14 })
          }
        ),
        fileContextDisplay && /* @__PURE__ */ jsx("div", { className: "mt-1", children: /* @__PURE__ */ jsx(
          "button",
          {
            type: "button",
 ...
 */
const FileIcon = ({ size = 16, className, ...props }) => /* @__PURE__ */ jsx(
  "svg",
  {
    xmlns: "http://www.w3.org/2000/svg",
    viewBox: "0 0 16 16",
    ...
    "aria-hidden": "true",
    ...props,
    children: /* @__PURE__ */ jsx("path", { d: "M9 2H4a2 2 0 0 0-2 2v8a2 2 0 0 0 2 2h8a2 2 0 0 0 2-2V7l-5-5zm3 7V3.5L10.5 2H10v3a1 1 0 0 1-1 1H6a1 1 0 0 1-1-1V2H4a1 1 0 0 0-1 1v8a1 1 0 0 0 1 1h8a1 1 0 0 0 1-1zM6 3h3v2H6V3z" })
  }
);
const FileListIcon = ({
  size = 16,
  ...
  "svg",
  {
    ...
    "aria-hidden": "true",
    ...props,
    children: /* @__PURE__ */ jsx("path", { d: "M5 3.5a.5.5 0 0 1 .5-.5h4a.5.5 0 0 1 0 1h-4a.5.5 0 0 1-.5-.5Zm0 2a.5.5 0 0 1 .5-.5h7a.5.5 0 0 1 0 1h-7a.5.5 0 0 1-.5-.5Zm0 2a.5.5 0 0 1 .5-.5h7a.5.5 0 0 1 0 1h-7a.5.5 0 0 1-.5-.5Zm0 2a.5.5 0 0 1 .5-.5h7a.5.5 0 0 1 0 1h-7a.5.5 0 0 1-.5-.5Z" })
  }
);
const SaveDocumentIcon = ({
  ...
  "svg",
  {
    ...
    ...props,
    children: [
      /* @__PURE__ */ jsx("path", { d: "M2.66663 2.66663H10.6666L13.3333 5.33329V13.3333H2.66663V2.66663Z" }),
      /* @__PURE__ */ jsx("path", { d: "M8 10.6666V8M8 8V5.33329M8 8H10.6666M8 8H5.33329" })
    ]
  }
);
const FolderIcon = ({
  ...
  "svg",
  {
    ...
    "aria-hidden": "true",
    ...props,
    children: /* @__PURE__ */ jsx("path", { d: "M1.5 3A1.5 1.5 0 0 1 3 1.5h3.086a1.5 1.5 0 0 1 1.06.44L8.5 3H13A1.5 1.5 0 0 1 14.5 4.5v7A1.5 1.5 0 0 1 13 13H3A1.5 1.5 0 0 1 1.5 11.5v-8Z" })
  }
);
/**
 * @license
...
const TerminalIcon = ({
  ...
  "svg",
  {
    ...
    children: [
      ...
      /* @__PURE__ */ jsx("path", { d: "M14.5 12C14.7761 12 15 12.2239 15 12.5C15 12.7761 14.7761 13 14.5 13H9.5C9.22386 13 9 12.7761 9 12.5C9 12.2239 9.22386 12 9.5 12H14.5Z" }),
      /* @__PURE__ */ jsx(
        "path",
        {
          fillRule: "evenodd",
...
const ThinkingMessageBase = ({
  ...
  return /* @__PURE__ */ jsx(
    "div",
    {
      ...
      children: /* @__PURE__ */ jsxs("div", { className: "thinking-content-wrapper", children: [
        /* @__PURE__ */ jsxs(
          "button",
          {
            type: "button",
            ...
            children: [
              /* @__PURE__ */ jsx("span", { className: "thinking-label", children: "Thinking" }),
              /* @__PURE__ */ jsx(
                ChevronIcon,
                {
                  size: 12,
        ...
        isExpanded && /* @__PURE__ */ jsx("div", { className: "thinking-content", children: /* @__PURE__ */ jsx(MessageContent, { content, onFileClick }) })
      ] })
    }
  );
};
ThinkingMessageBase.displayName = "ThinkingMessage";
const ThinkingMessage = memo(ThinkingMessageBase);
const AssistantMessageBase = ({
  ...
  return /* @__PURE__ */ jsx(
    "div",
    {
      ...
      children: /* @__PURE__ */ jsxs("span", { style: { width: "100%" }, children: [
        /* @__PURE__ */ jsx(
          "div",
          {
            style: {
        ...
        /* @__PURE__ */ jsx(MessageMeta, { timestamp, copyText: content })
      ] })
    }
  );
};
AssistantMessageBase.displayName = "AssistantMessage";
const AssistantMessage = memo(AssistantMessageBase);
/**
 * @license
 * Copyright 2025 Qwen Team
 * SPDX-License-Identifier: Apache-2.0
...
const InsightProgressCard = ({
  ...
  return /* @__PURE__ */ jsx("div", { className: "w-full px-[30px] py-2", children: /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-[minmax(0,1fr)_auto] items-center gap-x-4 gap-y-1", children: [
    /* @__PURE__ */ jsx("div", { className: "min-w-0 truncate text-sm leading-6 text-[var(--vscode-foreground)]", children: stage }),
    /* @__PURE__ */ jsxs("div", { className: "row-span-2 shrink-0 self-center text-xs leading-none tabular-nums text-[var(--vscode-descriptionForeground)]", children: [
      percent,
      "%"
    ] }),
    detail ? /* @__PURE__ */ jsx("div", { className: "min-w-0 truncate text-xs leading-5 text-[var(--vscode-descriptionForeground)]", children: detail }) : /* @__PURE__ */ jsx("div", { className: "text-xs leading-5 text-[var(--vscode-descriptionForeground)]", children: "Processing your chat history…" })
  ] }) });
};
const AskUserQuestionDialog = ({
  ...
  const renderTabs = () => /* @__PURE__ */ jsxs("div", { className: "flex gap-2 mb-4 overflow-x-auto", children: [
    questions.map((q, idx) => {
      ...
      return /* @__PURE__ */ jsxs(
        "button",
        {
          ...
          children: [
            /* @__PURE__ */ jsx("span", { children: q.header }),
            isAnswered && /* @__PURE__ */ jsx("span", { className: "text-green-500", children: "✓" })
          ]
        },
        idx
      );
      ...
      "div",
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxs("div", { className: "mb-4", children: [
            /* @__PURE__ */ jsx("div", { className: "font-bold text-[var(--app-primary-foreground)] mb-2", children: "Your answers:" }),
            questions.map((q, idx) => {
              const answer = getAnswerForQuestion(idx);
              return /* @__PURE__ */ jsxs(
                "div",
                {
                  ...
                  children: [
                    ...
                    " ",
                    answer ? /* @__PURE__ */ jsx("span", { style: { color: "var(--app-link-color)" }, children: answer }) : /* @__PURE__ */ jsx("span", { className: "opacity-60", children: "(not answered)" })
                  ]
                },
                idx
              );
  ...
  return /* @__PURE__ */ jsxs(
    "div",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "mb-4", children: [
          !hasMultipleQuestions && /* @__PURE__ */ jsx("div", { className: "mb-2", children: /* @__PURE__ */ jsx(
            "span",
            {
          ...
          /* @__PURE__ */ jsx("div", { className: "text-[var(--app-primary-foreground)] text-base", children: currentQuestion.question })
        ] }),
        /* @__PURE__ */ jsxs("div", { className: "flex flex-col gap-2 mb-3", children: [
            ...
            return /* @__PURE__ */ jsxs("div", { className: "flex flex-col", children: [
              /* @__PURE__ */ jsxs(
                "button",
                {
                  ...
                  children: [
                    isMultiSelect ? /* @__PURE__ */ jsx("span", { className: "min-w-[18px]", children: isMultiChecked ? "☑" : "☐" }) : /* @__PURE__ */ jsx("span", { className: "min-w-[18px]", children: isSelected ? "●" : "○" }),
                    /* @__PURE__ */ jsx("span", { className: "flex-1", children: opt.label })
                  ]
                }
              ),
              opt.description && /* @__PURE__ */ jsx(
                "div",
                {
          ...
          /* @__PURE__ */ jsx("div", { className: "flex flex-col", children: showCustomInput ? /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
            ...
            "button",
            {
              ...
              children: [
                /* @__PURE__ */ jsx("span", { className: "min-w-[18px]", children: "✎" }),
                /* @__PURE__ */ jsx("span", { className: "flex-1 opacity-70", children: currentAnswer.customInput || "Other..." })
              ]
            }
          ) })
        ] }),
...
const ImagePreview = ({ images, onRemove }) => {
  ...
  return /* @__PURE__ */ jsx("div", { className: "image-preview-container flex gap-2 px-2 pb-2", children: images.map((image2) => /* @__PURE__ */ jsx("div", { className: "image-preview-item relative group", children: /* @__PURE__ */ jsxs("div", { className: "relative", children: [
    /* @__PURE__ */ jsx(
      "img",
      {
        src: image2.data,
...
const ImageMessageRenderer = ({
  ...
  return /* @__PURE__ */ jsx("div", { className: "qwen-message user-message-container flex gap-0 my-1 items-start text-left flex-col relative", children: /* @__PURE__ */ jsxs(
    "div",
    {
      className: "inline-block relative whitespace-pre-wrap rounded-md max-w-full overflow-x-auto overflow-y-hidden select-text leading-[1.5]",
      style: {
...
const ToolCallContainer = ({
  ...
  "div",
  {
    ...
    "data-first": isFirst,
    "data-last": isLast,
    children: /* @__PURE__ */ jsxs("div", { className: "toolcall-content-wrapper flex flex-col min-w-0 max-w-full", children: [
      /* @__PURE__ */ jsxs("div", { className: "flex items-baseline gap-1.5 relative min-w-0", children: [
        /* @__PURE__ */ jsx("span", { className: "text-[14px] leading-none font-bold text-[var(--app-primary-foreground)]", children: label }),
        /* @__PURE__ */ jsx("span", { className: "text-[11px] text-[var(--app-secondary-foreground)]", children: labelSuffix })
      ] }),
      children && /* @__PURE__ */ jsx("div", { className: "text-[var(--app-secondary-foreground)]", children })
    ] })
  }
);
const ToolCallCard = ({
  icon: _icon,
  children
}) => /* @__PURE__ */ jsx("div", { className: "grid grid-cols-[auto_1fr] gap-medium bg-[var(--app-input-background)] border border-[var(--app-input-border)] rounded-medium p-large my-medium items-start animate-[fadeIn_0.2s_ease-in] toolcall-card", children: /* @__PURE__ */ jsx("div", { className: "flex flex-col gap-medium min-w-0", children }) });
const ToolCallRow = ({ label, children }) => /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-[80px_1fr] gap-medium min-w-0", children: [
  /* @__PURE__ */ jsx("div", { className: "text-xs text-[var(--app-secondary-foreground)] font-medium pt-[2px]", children: label }),
  /* @__PURE__ */ jsx("div", { className: "text-[var(--app-primary-foreground)] min-w-0 break-words", children })
] });
...
const StatusIndicator = ({ status, text: text2 }) => /* @__PURE__ */ jsxs("div", { className: "inline-block font-medium relative", title: status, children: [
  /* @__PURE__ */ jsx(
    "span",
    {
...
const CodeBlock = ({ children }) => /* @__PURE__ */ jsx("pre", { className: "font-mono text-[var(--app-monospace-font-size)] bg-[var(--app-primary-background)] border border-[var(--app-input-border)] rounded-small p-medium overflow-x-auto mt-1 whitespace-pre-wrap break-words max-h-[300px] overflow-y-auto", children });
const LocationsList = ({ locations }) => /* @__PURE__ */ jsx("div", { className: "toolcall-locations-list flex flex-col gap-1 max-w-full", children: locations.map((loc, idx) => /* @__PURE__ */ jsx(FileLink, { path: loc.path, line: loc.line, showFullPath: true }, idx)) });
const CollapsibleOutput$1 = ({
  ...
  return /* @__PURE__ */ jsxs("div", { className: "flex flex-col gap-[3px]", children: [
    /* @__PURE__ */ jsx(
      "div",
      {
    ...
    isCollapsible && /* @__PURE__ */ jsx("div", { className: "flex justify-center border-t border-[var(--app-input-border)] pt-1", children: /* @__PURE__ */ jsx(
      "button",
      {
        type: "button",
        onClick: (event) => {
  ...
  return /* @__PURE__ */ jsxs(
    "button",
    {
      ...
      children: [
        ...
        showTooltip && /* @__PURE__ */ jsx("span", { className: "absolute -top-7 right-0 bg-[var(--app-tool-background)] text-[var(--app-primary-foreground)] px-2 py-1 rounded text-xs whitespace-nowrap border border-[var(--app-input-border)] pointer-events-none", children: "Copied!" })
      ]
    }
  );
};
...
const ThinkToolCall = ({
  ...
  if (textOutputs.length > 0) {
    ...
    if (isLong) {
      ...
      return /* @__PURE__ */ jsx(ToolCallCard, { icon: "💭", children: /* @__PURE__ */ jsx(ToolCallRow, { label: "Think", children: isCollapsible ? /* @__PURE__ */ jsx(
        CollapsibleOutput$1,
        {
          isCollapsible: true,
      ...
      ) : /* @__PURE__ */ jsx("div", { className: "italic opacity-90 leading-relaxed", children: thoughts }) }) });
    }
    ...
    return /* @__PURE__ */ jsx(
      ToolCallContainer,
      {
        ...
        isFirst,
        isLast,
        children: /* @__PURE__ */ jsx("span", { className: "italic opacity-90", children: thoughts })
      }
    );
  }
  return null;
...
const GenericToolCall = ({
  ...
  const { textOutputs, errors: errors2 } = groupContent(content);
  if (errors2.length > 0) {
    return /* @__PURE__ */ jsxs(ToolCallCard, { icon: "🔧", children: [
      /* @__PURE__ */ jsx(ToolCallRow, { label: displayLabel, children: /* @__PURE__ */ jsx("div", { children: operationText }) }),
      /* @__PURE__ */ jsx(ToolCallRow, { label: "Error", children: /* @__PURE__ */ jsx("div", { className: "text-[#c74e39] font-medium", children: errors2.join("\n") }) })
    ] });
  }
  if (textOutputs.length > 0) {
    ...
    if (isLong) {
      return /* @__PURE__ */ jsxs(ToolCallCard, { icon: "🔧", children: [
        /* @__PURE__ */ jsx(ToolCallRow, { label: displayLabel, children: /* @__PURE__ */ jsx("div", { children: operationText }) }),
        /* @__PURE__ */ jsx(ToolCallRow, { label: "Output", children: /* @__PURE__ */ jsx(
          CollapsibleOutput$1,
          {
            isCollapsible: output.length > EXPAND_THRESHOLD$1,
            className: "text-[13px] opacity-90",
            children: /* @__PURE__ */ jsx(MarkdownRenderer, { content: output, enableFileLinks: false })
          }
        ) })
      ] });
    }
  ...
  if (locations && locations.length > 0) {
    ...
    return /* @__PURE__ */ jsx(
      ToolCallContainer,
      {
        ...
        isFirst,
        isLast,
        children: /* @__PURE__ */ jsx(LocationsList, { locations })
      }
    );
  }
  if (operationText) {
...
const AgentToolCall = ({ toolCall }) => {
  ...
  return /* @__PURE__ */ jsxs(ToolCallCard, { icon: "🤖", children: [
    /* @__PURE__ */ jsx(ToolCallRow, { label: "Agent", children: /* @__PURE__ */ jsx("div", { className: "font-medium text-[var(--app-primary-foreground)]", children: getHeaderTitle(data, toolCall.title) }) }),
    /* @__PURE__ */ jsx(ToolCallRow, { label: "Status", children: /* @__PURE__ */ jsxs("div", { className: "flex flex-wrap items-center gap-2", children: [
      /* @__PURE__ */ jsx("span", { className: "font-medium", children: data.subagentName }),
      /* @__PURE__ */ jsx("span", { className: "text-[var(--app-secondary-foreground)]", children: STATUS_LABELS[data.status] })
    ] }) }),
    visibleToolCalls.length > 0 && /* @__PURE__ */ jsx(ToolCallRow, { label: data.status === "running" ? "Progress" : "Tools", children: /* @__PURE__ */ jsxs("div", { className: "flex flex-col gap-1", children: [
      visibleToolCalls.map((childToolCall) => /* @__PURE__ */ jsxs(
        "div",
        {
          className: "flex flex-wrap items-center gap-2",
          children: [
            /* @__PURE__ */ jsx("span", { className: "font-mono text-[12px] text-[var(--app-primary-foreground)]", children: childToolCall.name }),
            /* @__PURE__ */ jsx("span", { className: "text-[var(--app-secondary-foreground)]", children: CHILD_STATUS_LABELS[childToolCall.status] }),
            childToolCall.description && /* @__PURE__ */ jsx("span", { className: "text-[var(--app-secondary-foreground)]", children: childToolCall.description }),
            childToolCall.error && /* @__PURE__ */ jsx("span", { className: "text-[#c74e39]", children: childToolCall.error })
          ]
        },
        childToolCall.callId
      )),
      hiddenToolCallCount > 0 && /* @__PURE__ */ jsxs("div", { className: "text-[var(--app-secondary-foreground)]", children: [
        "+",
        hiddenToolCallCount,
        " more tool calls"
      ] })
    ] }) }),
    data.executionSummary && /* @__PURE__ */ jsx(ToolCallRow, { label: "Summary", children: /* @__PURE__ */ jsxs("div", { className: "flex flex-wrap gap-x-4 gap-y-1", children: [
      ...
      /* @__PURE__ */ jsx("span", { children: formatDuration(data.executionSummary.totalDurationMs) })
    ] }) }),
    (data.status === "failed" || data.status === "cancelled") && data.terminateReason && /* @__PURE__ */ jsx(ToolCallRow, { label: "Reason", children: /* @__PURE__ */ jsx("div", { className: "text-[#c74e39] font-medium", children: data.terminateReason }) })
  ] });
};
const EditToolCallContainer = ({
  ...
  "div",
  {
    ...
    "data-first": isFirst,
    "data-last": isLast,
    children: /* @__PURE__ */ jsxs("div", { className: "EditToolCall toolcall-content-wrapper flex flex-col gap-1 min-w-0 max-w-full", children: [
      /* @__PURE__ */ jsxs("div", { className: "flex items-baseline gap-1.5 relative min-w-0", children: [
        /* @__PURE__ */ jsx("span", { className: "text-[14px] leading-none font-bold text-[var(--app-primary-foreground)]", children: label }),
        /* @__PURE__ */ jsx("span", { className: "text-[11px] text-[var(--app-secondary-foreground)]", children: labelSuffix })
      ] }),
...
const EditToolCall = ({
  ...
  const { errors: errors2, diffs } = useMemo(() => groupContent(content), [content]);
  if (toolCall.status === "failed") {
    ...
    return /* @__PURE__ */ jsx(
      "div",
      {
        ...
        "data-first": isFirst,
        "data-last": isLast,
        children: /* @__PURE__ */ jsxs("div", { className: "toolcall-edit-content flex flex-col gap-1 min-w-0 max-w-full", children: [
          /* @__PURE__ */ jsx("div", { className: "flex items-center justify-between min-w-0", children: /* @__PURE__ */ jsxs("div", { className: "flex items-baseline gap-2 min-w-0", children: [
            /* @__PURE__ */ jsx("span", { className: "text-[13px] leading-none font-bold text-[var(--app-primary-foreground)]", children: "Edit" }),
            path && /* @__PURE__ */ jsx(
              FileLink,
              {
                path,
          ...
          /* @__PURE__ */ jsx("div", { className: "inline-flex text-[var(--app-secondary-foreground)] text-[0.85em] opacity-70 flex-row items-start w-full gap-1 flex items-center", children: /* @__PURE__ */ jsx("span", { className: "flex-shrink-0 w-full", children: "edit failed" }) })
        ] })
      }
    );
  }
  ...
  if (diffs.length > 0) {
    ...
    return /* @__PURE__ */ jsx(
      "div",
      {
        ...
        "data-last": isLast,
        children: /* @__PURE__ */ jsxs("div", { className: "toolcall-edit-content flex flex-col gap-1 min-w-0 max-w-full", children: [
          /* @__PURE__ */ jsx("div", { className: "flex items-center justify-between min-w-0", children: /* @__PURE__ */ jsxs("div", { className: "flex items-baseline gap-1.5 min-w-0", children: [
            /* @__PURE__ */ jsx("span", { className: "text-[13px] leading-none font-bold text-[var(--app-primary-foreground)]", children: "Edit" }),
            path && /* @__PURE__ */ jsx(
              FileLink,
              {
          ...
          /* @__PURE__ */ jsxs("div", { className: "inline-flex text-[var(--app-secondary-foreground)] text-[0.85em] opacity-70 flex-row items-start w-full gap-1 flex items-baseline", children: [
            /* @__PURE__ */ jsx("span", { className: "flex-shrink-0 relative top-[-0.1em]", children: "⎿" }),
            /* @__PURE__ */ jsx("span", { className: "flex-shrink-0 w-full", children: summary })
          ] })
        ] })
      }
    );
  ...
  if (locations && locations.length > 0) {
    ...
    return /* @__PURE__ */ jsx(
      EditToolCallContainer,
      {
        ...
        children: /* @__PURE__ */ jsxs("div", { className: "inline-flex text-[var(--app-secondary-foreground)] text-[0.85em] opacity-70 flex-row items-start w-full gap-1 flex items-center", children: [
          /* @__PURE__ */ jsx("span", { className: "flex-shrink-0 relative top-[-0.1em]", children: "⎿" }),
          /* @__PURE__ */ jsx(
            FileLink,
            {
  ...
  if (errors2.length > 0) {
    ...
    return /* @__PURE__ */ jsxs(
      ToolCallContainer,
      {
        ...
        children: [
          /* @__PURE__ */ jsxs("div", { className: "inline-flex text-[var(--app-secondary-foreground)] text-[0.85em] opacity-70 mt-[2px] mb-[2px] flex-row items-start w-full gap-1", children: [
            /* @__PURE__ */ jsx("span", { className: "flex-shrink-0 relative top-[-0.1em]", children: "⎿" }),
            /* @__PURE__ */ jsx("span", { className: "flex-shrink-0 w-full", children: errorMessage })
          ] }),
          truncatedContent && /* @__PURE__ */ jsx("div", { className: "bg-[var(--app-input-background)] border border-[var(--app-input-border)] rounded-md p-3 mt-1", children: /* @__PURE__ */ jsx("pre", { className: "font-mono text-[13px] whitespace-pre-wrap break-words text-[var(--app-primary-foreground)] opacity-90", children: truncatedContent }) })
        ]
      }
    );
  }
  if (locations && locations.length > 0) {
    ...
    return /* @__PURE__ */ jsx(
      ToolCallContainer,
      {
        ...
        children: /* @__PURE__ */ jsxs("div", { className: "inline-flex text-[var(--app-secondary-foreground)] text-[0.85em] opacity-70 flex-row items-start w-full gap-1 flex items-center", children: [
          /* @__PURE__ */ jsx("span", { className: "flex-shrink-0 relative top-[-0.1em]", children: "⎿" }),
          /* @__PURE__ */ jsxs("span", { className: "flex-shrink-0 w-full", children: [
            lineCount,
            " lines"
          ] })
        ] })
  ...
  return /* @__PURE__ */ jsxs("div", { className: "flex flex-col", children: [
    /* @__PURE__ */ jsxs(
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ jsx("span", { className: "flex-shrink-0 relative top-[-0.1em]", children: "⎿" }),
          /* @__PURE__ */ jsx("span", { className: "flex-shrink-0", children: summary })
        ]
      }
    ),
    isExpanded && /* @__PURE__ */ jsx("div", { className: "ml-4 mt-1 text-[var(--app-secondary-foreground)] text-[0.85em]", children })
  ] });
};
const SearchRow = ({
  label,
  children
}) => /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-[80px_1fr] gap-medium min-w-0", children: [
  /* @__PURE__ */ jsx("div", { className: "text-xs text-[var(--app-secondary-foreground)] font-medium pt-[2px]", children: label }),
  /* @__PURE__ */ jsx("div", { className: "text-[var(--app-primary-foreground)] min-w-0 break-words", children })
] });
const SearchCardContent = ({ children }) => /* @__PURE__ */ jsx("div", { className: "bg-[var(--app-input-background)] border border-[var(--app-input-border)] rounded-md p-3 mt-1", children: /* @__PURE__ */ jsx("div", { className: "flex flex-col gap-3 min-w-0", children }) });
const LocationsListLocal = ({ locations }) => /* @__PURE__ */ jsx("div", { className: "flex flex-col gap-1 max-w-full", children: locations.map((loc, idx) => /* @__PURE__ */ jsx(FileLink, { path: loc.path, line: loc.line, showFullPath: true }, idx)) });
  ...
  if (errors2.length > 0) {
    return /* @__PURE__ */ jsx(
      ToolCallContainer,
      {
        ...
        isFirst,
        isLast,
        children: /* @__PURE__ */ jsxs(SearchCardContent, { children: [
          /* @__PURE__ */ jsx(SearchRow, { label: "Query", children: /* @__PURE__ */ jsx("div", { className: "font-mono", children: queryText }) }),
          /* @__PURE__ */ jsx(SearchRow, { label: "Error", children: /* @__PURE__ */ jsx("div", { className: "text-[#c74e39] font-medium", children: errors2.join("\n") }) })
        ] })
      }
    );
  }
  if (locations && locations.length > 0) {
    ...
    return /* @__PURE__ */ jsx(
      ToolCallContainer,
      {
        ...
        isFirst,
        isLast,
        children: /* @__PURE__ */ jsx(CollapsibleOutput, { summary: summaryText, children: /* @__PURE__ */ jsx(LocationsListLocal, { locations }) })
      }
    );
  }
  if (textOutputs.length > 0) {
    ...
    return /* @__PURE__ */ jsx(
      ToolCallContainer,
      {
        ...
        isFirst,
        isLast,
        children: /* @__PURE__ */ jsx(CollapsibleOutput, { summary: summaryText, children: /* @__PURE__ */ jsx("div", { className: "flex flex-col gap-1 font-mono text-[0.85em] whitespace-pre-wrap break-all", children: textOutputs.map((text2, index) => /* @__PURE__ */ jsx("div", { children: text2 }, index)) }) })
      }
    );
  }
  if (queryText) {
...
const PlanToolCallContainer = ({
  ...
  "div",
  {
    ...
    "data-first": isFirst,
    "data-last": isLast,
    children: /* @__PURE__ */ jsxs("div", { className: "UpdatedPlanToolCall toolcall-content-wrapper flex flex-col gap-2 min-w-0 max-w-full", children: [
      /* @__PURE__ */ jsxs("div", { className: "flex items-baseline gap-1 relative min-w-0", children: [
        /* @__PURE__ */ jsx("span", { className: "text-[14px] leading-none font-bold text-[var(--app-primary-foreground)]", children: label }),
        /* @__PURE__ */ jsx("span", { className: "text-[11px] text-[var(--app-secondary-foreground)]", children: labelSuffix })
      ] }),
      children && /* @__PURE__ */ jsx("div", { className: "text-[var(--app-secondary-foreground)] py-1", children })
    ] })
  }
);
...
const UpdatedPlanToolCall = ({
  ...
  return /* @__PURE__ */ jsx(
    PlanToolCallContainer,
    {
      ...
      isFirst,
      isLast,
      children: /* @__PURE__ */ jsx("ul", { className: "Fr list-none p-0 m-0 flex flex-col gap-1", children: entries.map((entry, idx) => {
        ...
        return /* @__PURE__ */ jsxs(
          "li",
          {
            ...
            children: [
              /* @__PURE__ */ jsx("label", { className: "flex items-start gap-2", children: /* @__PURE__ */ jsx(
                CheckboxDisplay,
                {
                  checked: isDone,
...
const ShellToolCallImpl = ({
    ...
    return /* @__PURE__ */ jsxs(
      Container2,
      {
        ...
        children: [
          /* @__PURE__ */ jsxs("div", { className: "inline-flex text-[var(--app-secondary-foreground)] text-[0.85em] opacity-70 mt-[2px] mb-[2px] flex-row items-start w-full gap-1", children: [
            /* @__PURE__ */ jsx("span", { className: "flex-shrink-0 relative top-[-0.1em]", children: "⎿" }),
            /* @__PURE__ */ jsx("span", { className: "flex-shrink-0 w-full", children: commandText })
          ] }),
          /* @__PURE__ */ jsx("div", { className: `${classPrefix}-toolcall-card`, children: /* @__PURE__ */ jsxs("div", { className: `${classPrefix}-toolcall-content`, children: [
            /* @__PURE__ */ jsxs(
              "div",
              {
                ...
                children: [
                  /* @__PURE__ */ jsx("div", { className: `${classPrefix}-toolcall-label`, children: "IN" }),
                  /* @__PURE__ */ jsx("div", { className: `${classPrefix}-toolcall-row-content`, children: /* @__PURE__ */ jsx("pre", { className: `${classPrefix}-toolcall-pre`, children: inputCommand }) }),
                  /* @__PURE__ */ jsx(CopyButton, { text: inputCommand })
                ]
              }
            ),
            /* @__PURE__ */ jsxs("div", { className: `${classPrefix}-toolcall-row`, children: [
              /* @__PURE__ */ jsx("div", { className: `${classPrefix}-toolcall-label`, children: "Error" }),
              /* @__PURE__ */ jsx("div", { className: `${classPrefix}-toolcall-row-content`, children: /* @__PURE__ */ jsx(
                "pre",
                {
  ...
  if (textOutputs.length > 0) {
    ...
    const outputContent = /* @__PURE__ */ jsx("div", { className: `${classPrefix}-toolcall-output-subtle`, children: /* @__PURE__ */ jsx("pre", { className: `${classPrefix}-toolcall-pre`, children: output }) });
    return /* @__PURE__ */ jsxs(
      Container2,
      {
        label,
          ...
          /* @__PURE__ */ jsx("div", { className: `${classPrefix}-toolcall-card`, children: /* @__PURE__ */ jsxs("div", { className: `${classPrefix}-toolcall-content`, children: [
            ...
            /* @__PURE__ */ jsxs(
              "div",
              {
                ...
                style: { cursor: "pointer" },
                children: [
                  /* @__PURE__ */ jsx("div", { className: `${classPrefix}-toolcall-label`, children: "OUT" }),
                  /* @__PURE__ */ jsx(
                    "div",
                    {
                      className: `${classPrefix}-toolcall-row-content ${isCollapsible ? `${classPrefix}-toolcall-full` : ""}`,
                      children: isCollapsible ? /* @__PURE__ */ jsx(
                        CollapsibleOutput$1,
                        {
                          isCollapsible: true,
                          collapsedHeight: 60,
...
const ShellToolCall = (props) => {
  ...
  return /* @__PURE__ */ jsx(ShellToolCallImpl, { ...props, variant });
};
const ReadToolCallContainer = ({
  ...
  "div",
  {
    ...
    "data-first": isFirst,
    "data-last": isLast,
    children: /* @__PURE__ */ jsxs("div", { className: "toolcall-content-wrapper flex flex-col gap-1 min-w-0 max-w-full", children: [
      /* @__PURE__ */ jsxs("div", { className: "flex items-baseline gap-1.5 relative min-w-0", children: [
        /* @__PURE__ */ jsx("span", { className: "text-[14px] leading-none font-bold text-[var(--app-primary-foreground)]", children: label }),
        /* @__PURE__ */ jsx("span", { className: "text-[11px] text-[var(--app-secondary-foreground)]", children: labelSuffix })
      ] }),
      children && /* @__PURE__ */ jsx("div", { className: "text-[var(--app-secondary-foreground)] py-0.5", children })
    ] })
  }
);
const ReadToolCall = ({
  ...
  const { kind, title, content, locations, toolCallId } = toolCall;
  const platform = usePlatform();
  const openedDiffsRef = useRef(/* @__PURE__ */ new Map());
  const [isExpanded, setIsExpanded] = useControlledExpanded(false);
  const { errors: errors2, diffs, textOutputs } = useMemo(
  ...
  if (locations && locations.length > 0) {
    ...
    return /* @__PURE__ */ jsx(
      ReadToolCallContainer,
      {
        ...
        children: textContent ? /* @__PURE__ */ jsxs("div", { className: "border border-[var(--app-input-border)] rounded-[5px] bg-[var(--app-tool-background)] overflow-hidden", children: [
          /* @__PURE__ */ jsx(
            "div",
            {
              ...
              children: /* @__PURE__ */ jsx("pre", { className: "whitespace-pre-wrap break-words text-xs font-mono m-0", children: textContent })
            }
          ),
          isLongContent && /* @__PURE__ */ jsx(
            "button",
            {
              onClick: () => setIsExpanded(!isExpanded),
              "aria-expanded": isExpanded,
  ...
  if (textOutputs.length > 0) {
    ...
    return /* @__PURE__ */ jsx(
      ReadToolCallContainer,
      {
        ...
        isFirst,
        isLast,
        children: /* @__PURE__ */ jsxs("div", { className: "border border-[var(--app-input-border)] rounded-[5px] bg-[var(--app-tool-background)] overflow-hidden", children: [
          /* @__PURE__ */ jsx(
            "div",
            {
              className: `p-2 ${!isExpanded && isLongContent ? "max-h-[100px] overflow-hidden" : ""}`,
...
const OutputCard = ({ content, isError = false }) => {
  ...
  return /* @__PURE__ */ jsx("div", { className: "border-[0.5px] border-[var(--app-input-border)] rounded-[5px] bg-[var(--app-tool-background)] my-2 max-w-full text-[1em] items-start", children: /* @__PURE__ */ jsxs("div", { className: "flex flex-col gap-[3px] p-1", children: [
    /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-[max-content_1fr] p-1", children: [
      /* @__PURE__ */ jsx("div", { className: "text-[var(--app-secondary-foreground)] text-left opacity-50 py-1 px-2 pl-1 font-mono text-[0.85em]", children: "OUT" }),
      /* @__PURE__ */ jsx(
        "div",
        {
          ...
          children: isError ? /* @__PURE__ */ jsx("pre", { className: "m-0 overflow-hidden font-mono text-[0.85em] text-[#c74e39]", children: content }) : /* @__PURE__ */ jsx("div", { className: "text-[0.85em]", children: /* @__PURE__ */ jsx(MarkdownRenderer, { content, enableFileLinks: false }) })
        }
      )
    ] }),
    isLongContent && /* @__PURE__ */ jsx("div", { className: "flex justify-center border-t border-[var(--app-input-border)] pt-1", children: /* @__PURE__ */ jsx(
      "button",
      {
        type: "button",
        onClick: (event) => {
  ...
  if (errors2.length > 0) {
    return /* @__PURE__ */ jsx(
      ToolCallContainer,
      {
        ...
        children: /* @__PURE__ */ jsx(OutputCard, { content: errors2.join("\n"), isError: true })
      }
    );
  }
  if (textOutputs.length > 0) {
    ...
    return /* @__PURE__ */ jsx(
      ToolCallContainer,
      {
        ...
        isLast,
        labelSuffix: webTarget,
        children: /* @__PURE__ */ jsx(OutputCard, { content: output })
      }
    );
  }
  return /* @__PURE__ */ jsx(
...
const WebFetchToolCall = (props) => /* @__PURE__ */ jsx(WebFetchToolCallImpl, { ...props, variant: "fetch" });
/**
 * @license
 * Copyright 2025 Qwen Team
 * SPDX-License-Identifier: Apache-2.0
...
const ChatViewer = forwardRef(
  ({
    ...
    const [expandControl, setExpandControl] = useState({ signal: 0, expanded: false });
    ...
    const messagesRegion = /* @__PURE__ */ jsx(
      "div",
      {
        ref: scrollContainerRef,
        className: "chat-viewer-messages chat-messages",
        children: sortedMessages.length === 0 ? /* @__PURE__ */ jsxs("div", { className: "chat-viewer-empty", children: [
          showEmptyIcon && /* @__PURE__ */ jsx("div", { className: "chat-viewer-empty-icon", "aria-hidden": "true", children: "💬" }),
          /* @__PURE__ */ jsx("div", { className: "chat-viewer-empty-text", children: emptyMessage })
        ] }) : /* @__PURE__ */ jsxs(Fragment, { children: [
          sortedMessages.map(
            (msg, index) => renderMessage(msg, index, sortedMessages)
          ),
          /* @__PURE__ */ jsx("div", { ref: scrollAnchorRef, className: "chat-viewer-scroll-anchor" })
        ] })
      }
    );
    return /* @__PURE__ */ jsxs("div", { className: containerClasses, children: [
      showExpandToolbar && /* @__PURE__ */ jsxs(
        "div",
        {
      ...
      showExpandControl ? /* @__PURE__ */ jsx(ExpandControlContext.Provider, { value: expandControl, children: messagesRegion }) : messagesRegion
    ] });
  }
);
...
const Input = forwardRef(
  ({
    ...
    return /* @__PURE__ */ jsxs("div", { className: `${fullWidth ? "w-full" : "inline-block"}`, children: [
      label && /* @__PURE__ */ jsx(
        "label",
        {
          htmlFor: inputId,
      ...
      /* @__PURE__ */ jsxs("div", { className: "relative", children: [
        leftElement && /* @__PURE__ */ jsx("div", { className: "absolute left-3 top-1/2 -translate-y-1/2 text-gray-500", children: leftElement }),
        /* @__PURE__ */ jsx(
          "input",
          {
            ref,
        ...
        rightElement && /* @__PURE__ */ jsx("div", { className: "absolute right-3 top-1/2 -translate-y-1/2 text-gray-500", children: rightElement })
      ] }),
      errorMessage && error2 && /* @__PURE__ */ jsx("p", { id: `${inputId}-error`, className: "mt-1 text-sm text-red-600", children: errorMessage }),
      helperText && !error2 && /* @__PURE__ */ jsx("p", { id: `${inputId}-helper`, className: "mt-1 text-sm text-gray-500", children: helperText })
    ] });
  }
);
...
const PermissionDrawer = ({
  ...
  const getTitle = () => {
    ...
    if (toolCall.kind === "edit" || toolCall.kind === "write") {
      ...
      return /* @__PURE__ */ jsxs(Fragment, { children: [
        "Make this edit to",
        " ",
        /* @__PURE__ */ jsx("span", { className: "font-mono text-[var(--app-primary-foreground)]", children: fileName }),
        "?"
      ] });
    }
  ...
  return /* @__PURE__ */ jsx("div", { className: "fixed inset-x-0 bottom-0 z-[1000] p-2", children: /* @__PURE__ */ jsxs(
    "div",
    {
      ref: containerRef,
      ...
      children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "relative z-[1] text-[1.1em] text-[var(--app-primary-foreground)] flex flex-col min-h-0", children: [
          /* @__PURE__ */ jsx("div", { className: "font-bold text-[var(--app-primary-foreground)] mb-0.5", children: getTitle() }),
          (toolCall.kind === "edit" || toolCall.kind === "write" || toolCall.kind === "read" || toolCall.kind === "execute" || toolCall.kind === "bash" || isAgentTool(toolCall.toolName)) && toolCall.title && /* @__PURE__ */ jsx(
            "div",
            {
        ...
        planText && /* @__PURE__ */ jsx("div", { className: "relative z-[1] overflow-y-auto mb-2 rounded-[4px] max-h-[40vh] py-2 px-3 text-[13px] leading-normal bg-[var(--app-primary-background)] border border-[var(--app-input-border)] [scrollbar-width:thin] [&::-webkit-scrollbar]:w-1.5 [&::-webkit-scrollbar-track]:bg-transparent [&::-webkit-scrollbar-thumb]:rounded-full [&::-webkit-scrollbar-thumb]:bg-[var(--app-foreground-muted)]/30", children: /* @__PURE__ */ jsx(MarkdownRenderer, { content: planText }) }),
        editReviewText && /* @__PURE__ */ jsx("pre", { className: "relative z-[1] overflow-y-auto mb-2 rounded-[4px] max-h-[40vh] py-2 px-3 text-[13px] leading-normal whitespace-pre-wrap break-words bg-[var(--app-primary-background)] border border-[var(--app-input-border)] [scrollbar-width:thin] [&::-webkit-scrollbar]:w-1.5 [&::-webkit-scrollbar-track]:bg-transparent [&::-webkit-scrollbar-thumb]:rounded-full [&::-webkit-scrollbar-thumb]:bg-[var(--app-foreground-muted)]/30", children: editReviewText }),
        /* @__PURE__ */ jsx("div", { className: "relative z-[1] flex flex-col gap-1 pb-1", children: options.map((option, index) => {
          ...
          return /* @__PURE__ */ jsxs(
            "button",
            {
              ...
              children: [
                /* @__PURE__ */ jsx("span", { className: "inline-flex items-center justify-center min-w-[10px] h-5 font-semibold opacity-60", children: index + 1 }),
                /* @__PURE__ */ jsx("span", { className: "font-semibold", children: option.name })
              ]
            },
            option.optionId
          );
...
const WebviewContainer = ({
  children,
  className = ""
}) => /* @__PURE__ */ jsx("div", { className: `qwen-webui-container ${className}`, children });
export {
  AgentToolCall,
  ArrowUpIcon,
  ...
  ChatHeader,
  ChatViewer,
  ChatViewer as ChatViewerDefault,
  CheckboxDisplay,
  ChevronDownIcon,
  CloseIcon,
  CloseSmallIcon,
  CloseIcon$1 as CloseXIcon,
  CodeBlock,
  CodeBracketsIcon,
  CollapsibleFileContent,
  CompletionMenu,
