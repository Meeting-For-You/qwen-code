 ...
 */
import type { DaemonTextDeltaMeta, DaemonToolTranscriptBlock, DaemonTranscriptBlock, DaemonTranscriptReducerOptions, DaemonTranscriptState, DaemonUiEvent, DaemonUnrecognizedDiagnostic } from './types.js';
/**
 ...
 */
export declare const UNRECOGNIZED_DIAGNOSTICS_LIMIT = 50;
/**
 ...
 */
export declare function isTrimmedToolBlockId(blockId: string | undefined): boolean;
/**
 ...
 * stale sentinel win.
 */
export declare function isTrimmedPermissionBlockId(blockId: string | undefined): boolean;
...
export declare function estimateDaemonTranscriptBlockBytes(block: DaemonTranscriptBlock): number;
 ...
 */
export declare function selectUnrecognizedDiagnostics(state: DaemonTranscriptState): readonly DaemonUnrecognizedDiagnostic[];
/**
