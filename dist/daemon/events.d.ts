 ...
 */
import type { DaemonBranchPoint, DaemonEvent, DaemonErrorKind, DaemonMcpTransport, DaemonSessionArtifactChange, DaemonSessionPrInfo, DaemonSkillToggleMutation, PermissionOutcome, PromptContentBlock } from './types.js';
...
export declare function isSettingsChangedData(value: unknown): value is DaemonSettingsChangedData;
