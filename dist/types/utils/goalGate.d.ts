 ...
 */
export declare function isGoalGateBlocked(connection: GoalGateConnection): boolean;
 ...
 */
export declare function canResumeGoal(goal: GoalResumeGateRecord): boolean;
