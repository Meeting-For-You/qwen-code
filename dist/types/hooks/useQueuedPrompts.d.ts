 ...
 */
import { type DaemonSessionActions, type DaemonStreamingState, type DaemonWorkspaceActions } from '@qwen-code/webui/daemon-react-sdk';
...
export interface UseQueuedPromptsResult {
    ...
    queuedTexts: string[];
    enqueuePrompt: (text: string, images?: PromptImage[], files?: PromptFile[], onComplete?: () => void, inputAnnotations?: DaemonInputAnnotation[], onAdmitted?: () => void) => boolean;
...
export declare function useQueuedPrompts({ connected, writeBlocked, sessionId, workspaceCwd, clientId, canMutateMidTurn, canQueryMidTurn, canInjectMidTurnMedia, workspaceFileActions, streamingState, sessionHasActivePrompt, holdQueuedPromptsLocally, sessionActions, store, editorRef, reportError, t, }: UseQueuedPromptsArgs): UseQueuedPromptsResult;
export {};
