...
import type { DaemonSessionAgentTaskStatus, DaemonTranscriptBlock, DaemonSessionMonitorTaskStatus, DaemonSessionTaskStatus, DaemonWorkspaceCapability } from '@qwen-code/sdk/daemon';
...
export interface WebShellProps {
     ...
     */
    prepareSubmit?: (submission: WebShellSubmitSnapshot) => Promise<void | WebShellPreparedSubmit>;
    /**
