 ...
 */
import type { DaemonWorkspaceCapability, DaemonSessionSummary } from '@qwen-code/sdk/daemon';
...
export declare function ScheduledTasksDialog({ onRunPrompt, onCreateViaChat, onOpenSession, workspaces, lockedWorkspace, currentSession, currentSessionSchedulingAvailable, onError, }: ScheduledTasksDialogProps): import("react/jsx-runtime").JSX.Element;
export {};
