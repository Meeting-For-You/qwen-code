...
export declare const TURN_OUTPUT_VISIBLE_LIMIT = 3;
export declare function visibleTurnOutputs<T>(items: readonly T[], expanded: boolean): readonly T[];
...
export declare function canOpenWorkspaceArtifact(artifact: DaemonSessionArtifact): boolean;
export declare function getWorkspaceArtifactOpenBlockReason(artifact: DaemonSessionArtifact, t: (key: string, vars?: Record<string, string | number>) => string): string | undefined;
export declare function displayPath(path: string, workspaceCwd?: string): string;
export {};
