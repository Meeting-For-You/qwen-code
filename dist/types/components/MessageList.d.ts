...
export declare function applyTurnCollapse(items: DisplayItem[], { overrides, isResponding, activeTurnStartedAt, backgroundSummaryGraceActive, waitForUnmatchedAgentCompletions, waitForOrderedNarration, terminalBackgroundShellTaskIds, automaticallyExpandedAgentKeys, pendingApprovalCallId, includeSubagentToolUsageInMetrics, enabled, }: ApplyTurnCollapseOptions): DisplayItem[];
/**
