...
export declare function ThinkingTranslateButton({ content, generateContent, className, }: ThinkingTranslateButtonProps): import("react/jsx-runtime").JSX.Element;
...
export declare function ThinkingDoneIcon(): import("react/jsx-runtime").JSX.Element;
export {};
