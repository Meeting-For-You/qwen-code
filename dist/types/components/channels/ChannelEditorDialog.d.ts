...
export declare function ChannelEditorDialog({ open, descriptor, instance, expectedRevision, existingNames, workspaces, workspaceCwd, workspaceLoading, onWorkspaceChange, onOpenChange, onSave, onReload, listPairingRequests, approvePairingRequest, listPairingApprovals, revokePairingApproval, }: ChannelEditorDialogProps): import("react/jsx-runtime").JSX.Element;
