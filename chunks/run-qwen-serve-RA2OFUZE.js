...
async function loadChannelWorkerRuntime() {
  channelWorkerRuntimePromise ??= Promise.all([
    ...
    import("./pidfile-KEOJAMMT.js"),
    import("./runtime-3J62PYZS.js"),
...
function loadCoreRuntime() {
  coreRuntimePromise ??= import("./core-runtime-D74GX426.js");
...
function loadSettingsRuntimeModules() {
  settingsRuntimePromise ??= Promise.all([
    import("./settings-ZM3ZQPX7.js"),
    import("./environment-E7F4EHZO.js"),
    import("./loadedSettingsAdapter-T7MPJ6U4.js"),
    import("./trustedFolders-AKS63CQ7.js")
...
function loadChannelWebhookConfigRuntime() {
  channelWebhookConfigRuntimePromise ??= Promise.all([
    import("./runtime-3J62PYZS.js"),
    import("./config-utils-DXFIEXIH.js")
...
async function loadServeRuntimeModules() {
  const [
    ...
    import("./server-SNNFTV3R.js"),
    import("./bridge-AD5J666G.js"),
    import("./spawnChannel-22WUABBQ.js"),
    import("./process-registry-PMJOA5CO.js"),
    import("./workspace-service-6FOHYON7.js"),
    import("./types-WYCFCEHR.js"),
    import("./daemon-status-provider-JJNLLDEN.js"),
    import("./workspace-providers-status-S66TM3UN.js"),
    import("./workspace-skills-status-OIIPEYS2.js"),
    import("./total-session-admission-S66CR634.js"),
    import("./workspace-registry-MP2274SQ.js"),
    import("./prompt-terminal-ledger-7ZSZOLYW.js")
  ]);
  return {
...
async function runQwenServeImpl(optsIn, deps, loggerLifecycle) {
  ...
  if (workspaceRegistrationStore === void 0 && process.env["QWEN_SERVE_NO_PERSISTENT_REGISTRATION"] !== "1") {
    const { WorkspaceRegistrationStore } = await import("./workspace-registration-store-3462P3AQ.js");
  ...
  const { createDaemonToolGuard } = await import("./daemon-git-worktree-guard-GI3O6AN4.js");
  ...
  const buildRuntime = /* @__PURE__ */ __name(async () => {
    const [runtime, core, settingsRuntime, resolvedCliVersion, trustPolicy] = await Promise.all([
      ...
      cliVersionPromise,
      import("./daemon-trust-policy-EF25VVDE.js")
    ]);
    ...
    const persistDisabledSkillsFn = /* @__PURE__ */ __name((workspace, skillName, enabled, assertGenerationOpen) => withSettingsLock(workspace, async () => {
      ...
      } = await import("./skill-settings-HO5GUFVT.js");
      const fresh = loadSettingsForPersistence(workspace);
    ...
    const [{ createSubSessionLauncher }, scheduledTaskRoutes] = await Promise.all([
      import("./create-sub-session-IFKKASU2.js"),
      import("./scheduled-tasks-PNPYWSQK.js")
    ]);
    ...
    const channelManagementService = /* @__PURE__ */ __name((targetRuntime) => {
      ...
      const pending = (async () => {
        ...
        const [
          ...
          import("./channel-settings-store-QH32I2QZ.js")
        ]);
    ...
    if (workspaceTrustHotReloadAvailable) {
      const [
        ...
        import("./workspace-trust-reconciler-3JM4PC3K.js"),
        import("./daemon-trust-policy-monitor-6XZZRECZ.js")
      ]);
  ...
  const channelValidationTrustPolicy = opts.channelSelection ? await import("./daemon-trust-policy-EF25VVDE.js") : void 0;
