  ...
  try {
    if (authType === "openai" /* USE_OPENAI */) {
      loadBaseGenerator = /* @__PURE__ */ __name(async () => {
        const { createOpenAIContentGenerator } = await import("./openaiContentGenerator-YPXCE7ZE.js");
      ...
      try {
        ...
        loadBaseGenerator = /* @__PURE__ */ __name(async () => {
          const { QwenContentGenerator } = await import("./qwenContentGenerator-DSGXWZ5F.js");
      ...
      loadBaseGenerator = /* @__PURE__ */ __name(async () => {
        const { createGeminiContentGenerator } = await import("./geminiContentGenerator-PUOMTMKI.js");
  ...
  return new LazyContentGenerator(async () => {
    try {
      const [baseGenerator, { LoggingContentGenerator }] = await Promise.all([
        loadBaseGenerator(),
        import("./loggingContentGenerator-Z2YUQYWM.js")
      ]);
