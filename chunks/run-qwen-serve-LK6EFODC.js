...
async function loadChannelWorkerRuntime() {
  channelWorkerRuntimePromise ??= Promise.all([
    ...
    import("./pidfile-7Z75RDCE.js"),
    import("./runtime-JBBN4S7L.js"),
...
function loadCoreRuntime() {
  coreRuntimePromise ??= import("./core-runtime-UO26TR2M.js");
...
function loadSettingsRuntimeModules() {
  settingsRuntimePromise ??= Promise.all([
    import("./settings-5NDO25DL.js"),
    import("./environment-2ZQHLQNL.js"),
    import("./loadedSettingsAdapter-BJYK4NUL.js"),
    import("./trustedFolders-KV72YZXV.js")
...
function loadChannelWebhookConfigRuntime() {
  channelWebhookConfigRuntimePromise ??= Promise.all([
    import("./runtime-JBBN4S7L.js"),
    import("./config-utils-HZ7UROPR.js")
...
async function loadServeRuntimeModules() {
  const [
    ...
    import("./server-TDXHY6RY.js"),
    import("./bridge-RMVECNKY.js"),
    import("./spawnChannel-5DG4P3ZR.js"),
    import("./process-registry-PMJOA5CO.js"),
    import("./workspace-service-MJUW43ZT.js"),
    import("./types-WYCFCEHR.js"),
    import("./daemon-status-provider-FWDVK5HC.js"),
    import("./workspace-providers-status-HMD5ZP36.js"),
    import("./workspace-skills-status-5WLXFWAG.js"),
    import("./total-session-admission-B5CUUEAJ.js"),
    import("./workspace-registry-BKWTAQCQ.js"),
    import("./prompt-terminal-ledger-PN2UGNQM.js")
  ]);
  return {
...
async function runQwenServeImpl(optsIn, deps, loggerLifecycle) {
  ...
  if (workspaceRegistrationStore === void 0 && process.env["QWEN_SERVE_NO_PERSISTENT_REGISTRATION"] !== "1") {
    const { WorkspaceRegistrationStore } = await import("./workspace-registration-store-KJEH3B76.js");
  ...
  const { createDaemonToolGuard } = await import("./daemon-git-worktree-guard-4D3BHGK7.js");
  ...
  const buildRuntime = /* @__PURE__ */ __name(async () => {
    const [runtime, core, settingsRuntime, resolvedCliVersion, trustPolicy] = await Promise.all([
      ...
      cliVersionPromise,
      import("./daemon-trust-policy-IQ2RZAZ6.js")
    ]);
    ...
    const persistDisabledSkillsFn = /* @__PURE__ */ __name((workspace, skillName, enabled, assertGenerationOpen) => withSettingsLock(workspace, async () => {
      ...
      } = await import("./skill-settings-EY3PRYNS.js");
      const fresh = loadSettingsForPersistence(workspace);
    ...
    const [{ createSubSessionLauncher }, scheduledTaskRoutes] = await Promise.all([
      import("./create-sub-session-KZJUUZPB.js"),
      import("./scheduled-tasks-Q7EYHWKN.js")
    ]);
    ...
    const channelManagementService = /* @__PURE__ */ __name((targetRuntime) => {
      ...
      const pending = (async () => {
        ...
        const [
          ...
          import("./channel-settings-store-DG46MKEI.js")
        ]);
    ...
    if (workspaceTrustHotReloadAvailable) {
      const [
        ...
        import("./workspace-trust-reconciler-7JNYQUVC.js"),
        import("./daemon-trust-policy-monitor-SM2ZO62V.js")
      ]);
  ...
  const channelValidationTrustPolicy = opts.channelSelection ? await import("./daemon-trust-policy-IQ2RZAZ6.js") : void 0;
