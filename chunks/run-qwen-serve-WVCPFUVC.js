...
async function loadChannelWorkerRuntime() {
  channelWorkerRuntimePromise ??= Promise.all([
    ...
    import("./pidfile-MV3PYKXL.js"),
    import("./runtime-2U6YQVTU.js"),
...
function loadCoreRuntime() {
  coreRuntimePromise ??= import("./core-runtime-6JA4VFGF.js");
...
function loadSettingsRuntimeModules() {
  settingsRuntimePromise ??= Promise.all([
    import("./settings-PIEYB6XK.js"),
    import("./environment-MDUYNG3L.js"),
    import("./loadedSettingsAdapter-4CMBBWOK.js"),
    import("./trustedFolders-F3QQVIAM.js")
...
function loadChannelWebhookConfigRuntime() {
  channelWebhookConfigRuntimePromise ??= Promise.all([
    import("./runtime-2U6YQVTU.js"),
    import("./config-utils-ZNNMCTZF.js")
...
async function loadServeRuntimeModules() {
  const [
    ...
    import("./server-D5QHZEAC.js"),
    import("./bridge-FUSF5B7B.js"),
    import("./spawnChannel-G33OCPA4.js"),
    import("./process-registry-PMJOA5CO.js"),
    import("./workspace-service-375CGGTI.js"),
    import("./types-WYCFCEHR.js"),
    import("./daemon-status-provider-3QTWJJTV.js"),
    import("./workspace-providers-status-ZV3F3P34.js"),
    import("./workspace-skills-status-6IFS7XYR.js"),
    import("./total-session-admission-5VCJF7E3.js"),
    import("./workspace-registry-MWFSZWFT.js"),
    import("./prompt-terminal-ledger-X5SPYOQQ.js")
  ]);
  return {
...
async function runQwenServeImpl(optsIn, deps, loggerLifecycle) {
  ...
  if (workspaceRegistrationStore === void 0 && process.env["QWEN_SERVE_NO_PERSISTENT_REGISTRATION"] !== "1") {
    const { WorkspaceRegistrationStore } = await import("./workspace-registration-store-RBOAFEWK.js");
  ...
  const { createDaemonToolGuard } = await import("./daemon-git-worktree-guard-OQBLXV36.js");
  ...
  const buildRuntime = /* @__PURE__ */ __name(async () => {
    const [runtime, core, settingsRuntime, resolvedCliVersion, trustPolicy] = await Promise.all([
      ...
      cliVersionPromise,
      import("./daemon-trust-policy-SSVGD4RR.js")
    ]);
    ...
    const persistDisabledSkillsFn = /* @__PURE__ */ __name((workspace, skillName, enabled, assertGenerationOpen) => withSettingsLock(workspace, async () => {
      ...
      } = await import("./skill-settings-6MCU7EPK.js");
      const fresh = loadSettingsForPersistence(workspace);
    ...
    const [{ createSubSessionLauncher }, scheduledTaskRoutes] = await Promise.all([
      import("./create-sub-session-EMPYG35T.js"),
      import("./scheduled-tasks-YTQ3TPTL.js")
    ]);
    ...
    const channelManagementService = /* @__PURE__ */ __name((targetRuntime) => {
      ...
      const pending = (async () => {
        ...
        const [
          ...
          import("./channel-settings-store-47UUTVYG.js")
        ]);
    ...
    if (workspaceTrustHotReloadAvailable) {
      const [
        ...
        import("./workspace-trust-reconciler-EX2FDM6K.js"),
        import("./daemon-trust-policy-monitor-WAVJGEV2.js")
      ]);
  ...
  const channelValidationTrustPolicy = opts.channelSelection ? await import("./daemon-trust-policy-SSVGD4RR.js") : void 0;
