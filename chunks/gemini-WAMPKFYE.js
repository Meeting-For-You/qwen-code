...
import "./chunk-DV3PRQPO.js";
import "./chunk-NPQ5ZKRP.js";
import "./chunk-MR3PXB6E.js";
import "./chunk-W4UMGWKD.js";
...
async function main() {
  ...
  if (argv.listExtensions) {
    ...
    const { handleList: handleListExtensions } = await import("./list-I5ITY4JW.js");
  ...
  const { themeManager, AUTO_THEME_NAME } = await import("./theme-manager-3TNKMHV2.js");
  ...
  if (!process.env["SANDBOX"]) {
    ...
    const onUpdateRelaunch = /* @__PURE__ */ __name(async (relaunchOnFailure) => {
      ...
      const { updateBeforeRelaunch } = await import("./update-relaunch-YD4JDHJZ.js");
...
${finalArgs[promptIndex + 1]}`;
  ...
  if (argv.resume !== void 0) {
    ...
    if (argv.resume === "") {
      const { showResumeSessionPicker } = await import("./StandaloneSessionPicker-OXOYOQY5.js");
  ...
  }
  {
    ...
    const nonInteractiveHousekeeping = !config.isInteractive() || config.getExperimentalZedIntegration() ? await import("./scheduler-I5JUJR36.js") : void 0;
    ...
    if (config.isInteractive() && !wasRaw && process.stdin.isTTY) {
      const { startEarlyInputCapture, stopAndGetCapturedInput } = await import("./earlyInputCapture-BLANSSUO.js");
    ...
    if (config.isInteractive()) {
      const { setMaxSizedBoxDebugging } = await import("./MaxSizedBox-LLA6JDW6.js");
    ...
    const { initializeApp } = await import("./initializer-HID2ZK5M.js");
    ...
    if (config.getExperimentalZedIntegration()) {
      ...
      const { runAcpAgent } = await import("./acpAgent-DFYF2PZ4.js");
    ...
    if (config.isInteractive()) {
      ...
      const { startInteractiveUI } = await import("./startInteractiveUI-4PM2RMXL.js");
...
${input}`;
    ...
    const { validateNonInteractiveAuth } = await import("./validateNonInterActiveAuth-Z75V65KN.js");
    ...
    if (inputFormat === "stream-json" /* STREAM_JSON */) {
      ...
      const { runNonInteractiveStreamJson } = await import("./session-AFR4KOXL.js");
    ...
    const { runNonInteractive } = await import("./nonInteractiveCli-PHQUF6XA.js");
    nonInteractiveHousekeeping?.startNonInteractiveOpenAILogHousekeeping(
      nonInteractiveConfig,
      settings
    );
