...
var debugLogger = createDebugLogger("MCP_HOT_RELOAD");
...
function recomputeMcpGating(settings, assembled, cwd, bootAllowed, isYolo) {
  ...
  return {
    ...
    pending: isYolo ? void 0 : getPendingGatedMcpServers(assembled, cwd)
  };
}
