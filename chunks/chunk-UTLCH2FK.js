...
var require_unevaluatedProperties = __commonJS({
  "packages/core/node_modules/ajv/dist/vocabularies/unevaluated/unevaluatedProperties.js"(exports) {
    "use strict";
    init_esbuild_shims();
    Object.defineProperty(exports, "__esModule", { value: true });
    var codegen_1 = require_codegen();
...
var require_applicator2 = __commonJS({
  "packages/core/node_modules/ajv/dist/refs/json-schema-2020-12/meta/applicator.json"(exports, module) {
    module.exports = {
      $schema: "https://json-schema.org/draft/2020-12/schema",
...
var require_unevaluated2 = __commonJS({
  "packages/core/node_modules/ajv/dist/refs/json-schema-2020-12/meta/unevaluated.json"(exports, module) {
    module.exports = {
      $schema: "https://json-schema.org/draft/2020-12/schema",
...
var require_content = __commonJS({
  "packages/core/node_modules/ajv/dist/refs/json-schema-2020-12/meta/content.json"(exports, module) {
    module.exports = {
      $schema: "https://json-schema.org/draft/2020-12/schema",
...
var require_format_annotation = __commonJS({
  "packages/core/node_modules/ajv/dist/refs/json-schema-2020-12/meta/format-annotation.json"(exports, module) {
    module.exports = {
      $schema: "https://json-schema.org/draft/2020-12/schema",
...
var require_meta_data = __commonJS({
  "packages/core/node_modules/ajv/dist/refs/json-schema-2020-12/meta/meta-data.json"(exports, module) {
    module.exports = {
      $schema: "https://json-schema.org/draft/2020-12/schema",
...
var require_validation2 = __commonJS({
  "packages/core/node_modules/ajv/dist/refs/json-schema-2020-12/meta/validation.json"(exports, module) {
    module.exports = {
      $schema: "https://json-schema.org/draft/2020-12/schema",
...
var Ajv2020Class = import__.default.default || import__.default;
var debugLogger = createDebugLogger("SchemaValidator");
var ajvOptions = {
  ...
  logger: {
    ...
    warn: /* @__PURE__ */ __name((...args) => {
      if (typeof args[0] === "string" && args[0].startsWith("unknown format ")) {
        return;
      }
      console.warn(...args);
    }, "warn"),
...
var ajvDefault = new AjvClass(ajvOptions);
var ajv2020 = new Ajv2020Class(ajvOptions);
var addFormatsFunc = addFormats.default || addFormats;
addFormatsFunc(ajvDefault);
addFormatsFunc(ajv2020);
var DRAFT_2020_12_SCHEMA = "https://json-schema.org/draft/2020-12/schema";
function isDraft2020Uri(uri) {
  if (typeof uri !== "string") return false;
  const normalized = uri.endsWith("#") ? uri.slice(0, -1) : uri;
  return normalized === DRAFT_2020_12_SCHEMA;
}
__name(isDraft2020Uri, "isDraft2020Uri");
function getValidator(schema) {
  if (typeof schema === "object" && schema !== null && "$schema" in schema && isDraft2020Uri(schema.$schema)) {
    return ajv2020;
  }
  return ajvDefault;
}
...
var SchemaValidator = class {
  ...
  static compileStrict(schema) {
    ...
    const strictOptions = {
      strictSchema: true,
      // catches unknown keywords (typos)
      strictRequired: false,
      // allow `required` without `properties`
      strictTypes: false,
      // allow inferred / partial type info
      validateFormats: false,
      // unknown `format` values don't fail
      allowUnionTypes: true
      // type: ["a","b"]
    };
    const strictAjv = isDraft2020Uri(
      schema.$schema
    ) ? new Ajv2020Class(strictOptions) : new AjvClass(strictOptions);
  ...
  static validate(schema, data) {
    ...
    try {
      ...
      debugLogger.warn(
        `Failed to compile schema (${schema?.["$schema"] ?? "<no $schema>"}): ${error instanceof Error ? error.message : String(error)}. Skipping parameter validation.`
      );
      return null;
    }
...
__name(resolvePropSchema, "resolvePropSchema");
...
__name(resolveArrayElementSchema, "resolveArrayElementSchema");
    ...
    if (Array.isArray(val)) {
      for (const item of val) {
        if (typeof item === "object" && item != null && !Array.isArray(item)) {
          const resolved = rootSchema ? resolvePropSchema(item, rootSchema) : item;
...
__name(getCompositionVariants, "getCompositionVariants");
...
__name(schemaHasObjectShape, "schemaHasObjectShape");
var DANGEROUS_PROP_KEYS = /* @__PURE__ */ new Set(["__proto__", "constructor", "prototype"]);
...
__name(getEffectiveProperties, "getEffectiveProperties");
function getAcceptedTypes(propSchema, rootSchema, depth = 0, cache = /* @__PURE__ */ new WeakMap()) {
...
__name(getAcceptedTypes, "getAcceptedTypes");
...
__name(valueToSchemaType, "valueToSchemaType");
...
__name(typeIsAccepted, "typeIsAccepted");
function fixStringifiedJsonValuesInArray(array, itemsSchema, root, key) {
  ...
  const resolvedInner = innerItems ? resolvePropSchema(innerItems, root) : void 0;
  const itemsAccepted = resolvedInner ? getAcceptedTypes(resolvedInner, root) : null;
...
__name(fixStringifiedJsonValuesInArray, "fixStringifiedJsonValuesInArray");
function fixStringifiedJsonValues(data, schema, rootSchema, depth = 0) {
  ...
  for (const key of Object.keys(data)) {
    ...
    const propSchema = properties?.[key] ?? (typeof additionalProps === "object" && additionalProps !== null ? additionalProps : void 0);
      ...
      if (Array.isArray(resolved["prefixItems"])) {
        for (let i = 0; i < value.length; i++) {
          ...
          if (typeof item === "object" && item !== null && !Array.isArray(item)) {
            ...
            if (elSchema["type"] === "array" || elSchema["items"] || elSchema["prefixItems"]) {
        ...
        if (itemsSchema) {
          ...
          if (schemaHasObjectShape(resolvedItems, root)) {
            ...
            for (let i = 0; i < value.length; i++) {
              ...
              } else if (typeof item === "string" && itemsAccepted && !itemsAccepted.has("string")) {
                const trimmed2 = item.trim();
                if (trimmed2.startsWith("{") && trimmed2.endsWith("}") || trimmed2.startsWith("[") && trimmed2.endsWith("]")) {
                  try {
                    const parsed = JSON.parse(trimmed2);
                    if (itemsAccepted.has(
          ...
          } else if (resolvedItems["type"] === "array" || resolvedItems["items"] || resolvedItems["prefixItems"]) {
...
function fixBooleanValues(data, schema, rootSchema, depth = 0) {
  ...
  for (const key of Object.keys(data)) {
    ...
    const additionalProps = schema["additionalProperties"];
    const propSchema = properties?.[key] ?? (typeof additionalProps === "object" && additionalProps !== null ? additionalProps : void 0);
    const resolved = propSchema ? resolvePropSchema(propSchema, root) : void 0;
    if (typeof value === "object" && value !== null) {
      if (Array.isArray(value)) {
        if (Array.isArray(resolved?.["prefixItems"])) {
          for (let i = 0; i < value.length; i++) {
          ...
          if (itemsSchema) {
            ...
            if (schemaHasObjectShape(resolvedItems, root)) {
              ...
              const itemsAccepted = getAcceptedTypes(resolvedItems, root);
              if (itemsAccepted?.has("boolean") && !itemsAccepted.has("string")) {
                for (let i = 0; i < value.length; i++) {
                  const item = value[i];
      ...
      if (Array.isArray(value)) {
        if (Array.isArray(resolved["prefixItems"])) {
          ...
          for (let i = 0; i < value.length; i++) {
            ...
            } else if (item !== null && item !== void 0 && (typeof item === "number" || typeof item === "boolean" || typeof item === "bigint")) {
              const elAccepted = getAcceptedTypes(elSchema, root);
            ...
            if (resolvedItems) {
              if (schemaHasObjectShape(resolvedItems, root)) {
                ...
                if (itemsAccepted?.has("string")) {
                  ...
                  for (let i = 0; i < value.length; i++) {
                    const item = value[i];
                    if (item !== null && item !== void 0 && (typeof item === "number" || typeof item === "boolean" || typeof item === "bigint")) {
                      const currentType = valueToSchemaType(item);
                      if (currentType && !typeIsAccepted(currentType, itemsAccepted)) {
                        coerced ??= [...value];
                        debugLogger.debug(
...
__name(fixStringValues, "fixStringValues");
...
function hasCycleInSchema(schema) {
  ...
  function traverse(node, visitedRefs, pathRefs) {
    ...
    if ("$ref" in node && typeof node.$ref === "string") {
      ...
      const resolvedNode = resolveRef2(ref);
      if (resolvedNode) {
        visitedRefs.add(ref);
        pathRefs.add(ref);
...
__name(canonicalToolName, "canonicalToolName");
