...
var approvalModeCommand = {
  ...
  action: /* @__PURE__ */ __name(async (context, args) => {
    ...
    const autoModeNotices = mode === "auto" /* AUTO */ && priorMode !== "auto" /* AUTO */ && config ? await import("./useAutoAcceptIndicator-GYNQXEAD.js") : void 0;
    if (config) {
      try {
...
var expandNowCommand = {
  ...
  action: /* @__PURE__ */ __name(async (context) => {
    ...
    const { expandCollapsedHistory } = await import("./resumeHistoryUtils-7AYXFWNQ.js");
...
var updateCommand = {
  ...
  action: /* @__PURE__ */ __name(async (context) => {
    const [
      ...
      import("./updateCheck-CETSWZDZ.js"),
      import("./processUtils-E6ZJOJJO.js"),
      import("./standalone-update-F2BJTEE4.js"),
      import("./installationInfo-ZRPTGRXF.js")
    ]);
