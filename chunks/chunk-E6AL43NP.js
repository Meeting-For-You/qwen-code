  ...
  try {
    if (authType === "openai" /* USE_OPENAI */) {
      loadBaseGenerator = /* @__PURE__ */ __name(async () => {
        const { createOpenAIContentGenerator } = await import("./openaiContentGenerator-QOOWCAKP.js");
      ...
      try {
        ...
        loadBaseGenerator = /* @__PURE__ */ __name(async () => {
          const { QwenContentGenerator } = await import("./qwenContentGenerator-VZKQ5XKH.js");
      ...
      loadBaseGenerator = /* @__PURE__ */ __name(async () => {
        const { createGeminiContentGenerator } = await import("./geminiContentGenerator-QSB5NGCI.js");
  ...
  return new LazyContentGenerator(async () => {
    try {
      const [baseGenerator, { LoggingContentGenerator }] = await Promise.all([
        loadBaseGenerator(),
        import("./loggingContentGenerator-3OXMGB35.js")
      ]);
