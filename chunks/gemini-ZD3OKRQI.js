...
import "./chunk-LFQQTCEB.js";
import "./chunk-NPQ5ZKRP.js";
import "./chunk-MR3PXB6E.js";
import "./chunk-EZY3LIF6.js";
...
async function main() {
  ...
  if (argv.listExtensions) {
    ...
    const { handleList: handleListExtensions } = await import("./list-OFYKQXN5.js");
  ...
  const { themeManager, AUTO_THEME_NAME } = await import("./theme-manager-R3R6VKTM.js");
  ...
  if (!process.env["SANDBOX"]) {
    ...
    const onUpdateRelaunch = /* @__PURE__ */ __name(async (relaunchOnFailure) => {
      ...
      const { updateBeforeRelaunch } = await import("./update-relaunch-MWH76FT7.js");
...
${finalArgs[promptIndex + 1]}`;
  ...
  if (argv.resume !== void 0) {
    ...
    if (argv.resume === "") {
      const { showResumeSessionPicker } = await import("./StandaloneSessionPicker-4L4VLM7I.js");
  ...
  }
  {
    ...
    const nonInteractiveHousekeeping = !config.isInteractive() || config.getExperimentalZedIntegration() ? await import("./scheduler-J6DPOOTQ.js") : void 0;
    ...
    if (config.isInteractive() && !wasRaw && process.stdin.isTTY) {
      const { startEarlyInputCapture, stopAndGetCapturedInput } = await import("./earlyInputCapture-22Q2BKXU.js");
    ...
    if (config.isInteractive()) {
      const { setMaxSizedBoxDebugging } = await import("./MaxSizedBox-DBBWRB3S.js");
    ...
    const { initializeApp } = await import("./initializer-34DOO46D.js");
    ...
    if (config.getExperimentalZedIntegration()) {
      ...
      const { runAcpAgent } = await import("./acpAgent-S43K3OVU.js");
    ...
    if (config.isInteractive()) {
      ...
      const { startInteractiveUI } = await import("./startInteractiveUI-IDV2AXQW.js");
...
${input}`;
    ...
    const { validateNonInteractiveAuth } = await import("./validateNonInterActiveAuth-MHUO5OHV.js");
    ...
    if (inputFormat === "stream-json" /* STREAM_JSON */) {
      ...
      const { runNonInteractiveStreamJson } = await import("./session-HGUXZVCN.js");
    ...
    const { runNonInteractive } = await import("./nonInteractiveCli-BUXJQWO2.js");
    nonInteractiveHousekeeping?.startNonInteractiveOpenAILogHousekeeping(
      nonInteractiveConfig,
      settings
    );
