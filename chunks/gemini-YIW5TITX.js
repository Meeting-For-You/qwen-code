...
import "./chunk-TCV3BMIF.js";
import "./chunk-NPQ5ZKRP.js";
import "./chunk-MR3PXB6E.js";
import "./chunk-JIF7PTWO.js";
...
async function main() {
  ...
  if (argv.listExtensions) {
    ...
    const { handleList: handleListExtensions } = await import("./list-FC7YZQYN.js");
  ...
  const { themeManager, AUTO_THEME_NAME } = await import("./theme-manager-SPHNNRLL.js");
  ...
  if (!process.env["SANDBOX"]) {
    ...
    const onUpdateRelaunch = /* @__PURE__ */ __name(async (relaunchOnFailure) => {
      ...
      const { updateBeforeRelaunch } = await import("./update-relaunch-ME4E6OC2.js");
...
${finalArgs[promptIndex + 1]}`;
  ...
  if (argv.resume !== void 0) {
    ...
    if (argv.resume === "") {
      const { showResumeSessionPicker } = await import("./StandaloneSessionPicker-RZZFUTVL.js");
  ...
  }
  {
    ...
    const nonInteractiveHousekeeping = !config.isInteractive() || config.getExperimentalZedIntegration() ? await import("./scheduler-37DNFANT.js") : void 0;
    ...
    if (config.isInteractive() && !wasRaw && process.stdin.isTTY) {
      const { startEarlyInputCapture, stopAndGetCapturedInput } = await import("./earlyInputCapture-2SDXEDYH.js");
    ...
    if (config.isInteractive()) {
      const { setMaxSizedBoxDebugging } = await import("./MaxSizedBox-BQ5NM5SU.js");
    ...
    const { initializeApp } = await import("./initializer-V72POHWA.js");
    ...
    if (config.getExperimentalZedIntegration()) {
      ...
      const { runAcpAgent } = await import("./acpAgent-TKXGL7LR.js");
    ...
    if (config.isInteractive()) {
      ...
      const { startInteractiveUI } = await import("./startInteractiveUI-3PKHKRWB.js");
...
${input}`;
    ...
    const { validateNonInteractiveAuth } = await import("./validateNonInterActiveAuth-XXN5JTWW.js");
    ...
    if (inputFormat === "stream-json" /* STREAM_JSON */) {
      ...
      const { runNonInteractiveStreamJson } = await import("./session-6T2PDYEI.js");
    ...
    const { runNonInteractive } = await import("./nonInteractiveCli-TNKE6VV3.js");
    nonInteractiveHousekeeping?.startNonInteractiveOpenAILogHousekeeping(
      nonInteractiveConfig,
      settings
    );
