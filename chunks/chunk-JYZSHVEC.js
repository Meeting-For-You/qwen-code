...
var approvalModeCommand = {
  ...
  action: /* @__PURE__ */ __name(async (context, args) => {
    ...
    const autoModeNotices = mode === "auto" /* AUTO */ && priorMode !== "auto" /* AUTO */ && config ? await import("./useAutoAcceptIndicator-PLJQPMQB.js") : void 0;
    if (config) {
      try {
...
var expandNowCommand = {
  ...
  action: /* @__PURE__ */ __name(async (context) => {
    ...
    const { expandCollapsedHistory } = await import("./resumeHistoryUtils-L6TTXDVD.js");
...
var updateCommand = {
  ...
  action: /* @__PURE__ */ __name(async (context) => {
    const [
      ...
      import("./updateCheck-EG2JFLGL.js"),
      import("./processUtils-ES5NKRKM.js"),
      import("./standalone-update-L4ZOWIBS.js"),
      import("./installationInfo-N7TAZ4B2.js")
    ]);
