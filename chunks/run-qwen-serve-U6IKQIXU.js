...
async function loadChannelWorkerRuntime() {
  channelWorkerRuntimePromise ??= Promise.all([
    ...
    import("./pidfile-UNUOFHUJ.js"),
    import("./runtime-6CVJ4MEI.js"),
...
function loadCoreRuntime() {
  coreRuntimePromise ??= import("./core-runtime-JRZEKEAO.js");
...
function loadSettingsRuntimeModules() {
  settingsRuntimePromise ??= Promise.all([
    import("./settings-YFXMLW64.js"),
    import("./environment-5CXTFKHM.js"),
    import("./loadedSettingsAdapter-AAESMLFE.js"),
    import("./trustedFolders-4RXAC6XE.js")
...
function loadChannelWebhookConfigRuntime() {
  channelWebhookConfigRuntimePromise ??= Promise.all([
    import("./runtime-6CVJ4MEI.js"),
    import("./config-utils-PUVXOXR4.js")
...
async function loadServeRuntimeModules() {
  const [
    ...
    import("./server-ZQR4AUTW.js"),
    import("./bridge-3HLJUHHR.js"),
    import("./spawnChannel-PMBIJ44A.js"),
    import("./process-registry-PMJOA5CO.js"),
    import("./workspace-service-DICENA6Q.js"),
    import("./types-WYCFCEHR.js"),
    import("./daemon-status-provider-BVZ62S64.js"),
    import("./workspace-providers-status-2LZ3GAGF.js"),
    import("./workspace-skills-status-2Y65OA2O.js"),
    import("./total-session-admission-IS47EYQV.js"),
    import("./workspace-registry-7OXKWDRH.js"),
    import("./prompt-terminal-ledger-TIQUYAOI.js")
  ]);
  return {
...
async function runQwenServeImpl(optsIn, deps, loggerLifecycle) {
  ...
  if (workspaceRegistrationStore === void 0 && process.env["QWEN_SERVE_NO_PERSISTENT_REGISTRATION"] !== "1") {
    const { WorkspaceRegistrationStore } = await import("./workspace-registration-store-TCZ7MYBV.js");
  ...
  const { createDaemonToolGuard } = await import("./daemon-git-worktree-guard-LEZ3NGFE.js");
  ...
  const buildRuntime = /* @__PURE__ */ __name(async () => {
    const [runtime, core, settingsRuntime, resolvedCliVersion, trustPolicy] = await Promise.all([
      ...
      cliVersionPromise,
      import("./daemon-trust-policy-2ZRX6BNS.js")
    ]);
    ...
    const persistDisabledSkillsFn = /* @__PURE__ */ __name((workspace, skillName, enabled, assertGenerationOpen) => withSettingsLock(workspace, async () => {
      ...
      } = await import("./skill-settings-UQ7FZPCU.js");
      const fresh = loadSettingsForPersistence(workspace);
    ...
    const [{ createSubSessionLauncher }, scheduledTaskRoutes] = await Promise.all([
      import("./create-sub-session-YBA3MCYL.js"),
      import("./scheduled-tasks-NTMZ3ADQ.js")
    ]);
    ...
    const channelManagementService = /* @__PURE__ */ __name((targetRuntime) => {
      ...
      const pending = (async () => {
        ...
        const [
          ...
          import("./channel-settings-store-QW26XDLJ.js")
        ]);
    ...
    if (workspaceTrustHotReloadAvailable) {
      const [
        ...
        import("./workspace-trust-reconciler-2RYOQMVP.js"),
        import("./daemon-trust-policy-monitor-7YJNN6IC.js")
      ]);
  ...
  const channelValidationTrustPolicy = opts.channelSelection ? await import("./daemon-trust-policy-2ZRX6BNS.js") : void 0;
