...
var approvalModeCommand = {
  ...
  action: /* @__PURE__ */ __name(async (context, args) => {
    ...
    const autoModeNotices = mode === "auto" /* AUTO */ && priorMode !== "auto" /* AUTO */ && config ? await import("./useAutoAcceptIndicator-WQ7O4VN2.js") : void 0;
    if (config) {
      try {
...
var expandNowCommand = {
  ...
  action: /* @__PURE__ */ __name(async (context) => {
    ...
    const { expandCollapsedHistory } = await import("./resumeHistoryUtils-4JINOMNI.js");
...
var updateCommand = {
  ...
  action: /* @__PURE__ */ __name(async (context) => {
    const [
      ...
      import("./updateCheck-65FLW2DT.js"),
      import("./processUtils-7LMLYPN6.js"),
      import("./standalone-update-LU62RBP7.js"),
      import("./installationInfo-TNGJPGQH.js")
    ]);
