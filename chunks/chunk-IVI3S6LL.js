  ...
  try {
    if (authType === "openai" /* USE_OPENAI */) {
      loadBaseGenerator = /* @__PURE__ */ __name(async () => {
        const { createOpenAIContentGenerator } = await import("./openaiContentGenerator-PMOAIJW2.js");
      ...
      try {
        ...
        loadBaseGenerator = /* @__PURE__ */ __name(async () => {
          const { QwenContentGenerator } = await import("./qwenContentGenerator-VRQZAL42.js");
      ...
      loadBaseGenerator = /* @__PURE__ */ __name(async () => {
        const { createGeminiContentGenerator } = await import("./geminiContentGenerator-IIT5ADX7.js");
  ...
  return new LazyContentGenerator(async () => {
    try {
      const [baseGenerator, { LoggingContentGenerator }] = await Promise.all([
        loadBaseGenerator(),
        import("./loggingContentGenerator-TYJCWOKU.js")
      ]);
