  ...
  try {
    if (authType === "openai" /* USE_OPENAI */) {
      loadBaseGenerator = /* @__PURE__ */ __name(async () => {
        const { createOpenAIContentGenerator } = await import("./openaiContentGenerator-J5RNDXW5.js");
      ...
      try {
        ...
        loadBaseGenerator = /* @__PURE__ */ __name(async () => {
          const { QwenContentGenerator } = await import("./qwenContentGenerator-N73GD5E5.js");
      ...
      loadBaseGenerator = /* @__PURE__ */ __name(async () => {
        const { createGeminiContentGenerator } = await import("./geminiContentGenerator-HOAQY4YE.js");
  ...
  return new LazyContentGenerator(async () => {
    try {
      const [baseGenerator, { LoggingContentGenerator }] = await Promise.all([
        loadBaseGenerator(),
        import("./loggingContentGenerator-GHUBC6CU.js")
      ]);
